...
namespace AngularComponentsGeneratedServices.Services
{
    ...
    {
        private void CreateComponentCSSFile(DLLTypeInfo dllTypeInfoModels, List<DLLTypeInfo> DLLTypeInfoCSSPModelsList)
        {
            ...
            FileInfo fiOutputGen = new FileInfo(Config.GetValue<string>("ComponentCSSFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
            ...
            fiOutputGen = new FileInfo(Config.GetValue<string>("ComponentCSSFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
