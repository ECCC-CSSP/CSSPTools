...
namespace AngularComponentsGeneratedServices.Services
{
    ...
    {
        private void CreateComponentEditFile(DLLTypeInfo dllTypeInfoModels, List<DLLTypeInfo> DLLTypeInfoCSSPModelsList)
        {
            ...
            FileInfo fiOutputGen = new FileInfo(Config.GetValue<string>("ComponentEditFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
            ...
            fiOutputGen = new FileInfo(Config.GetValue<string>("ComponentEditFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
