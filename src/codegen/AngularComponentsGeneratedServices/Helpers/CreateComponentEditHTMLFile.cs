...
namespace AngularComponentsGeneratedServices.Services
{
    ...
    {
        private void CreateComponentEditHTMLFile(DLLTypeInfo dllTypeInfoModels, List<DLLTypeInfo> DLLTypeInfoCSSPModelsList)
        {
            ...
            fiOutputGen = new FileInfo(Config.GetValue<string>("ComponentEditHTMLFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
