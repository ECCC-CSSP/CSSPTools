...
namespace AngularComponentsGeneratedServices.Services
{
    ...
    {
        private void CreateLocalesFile(DLLTypeInfo dllTypeInfoModels, List<DLLTypeInfo> DLLTypeInfoCSSPModelsList)
        {
            ...
            sb.AppendLine($@"import {{ { dllTypeInfoModels.Name }TextModel }}");
            sb.AppendLine($@"from './{ dllTypeInfoModels.Name.ToLower() }.models';");
            sb.AppendLine($@"import {{ { dllTypeInfoModels.Name }Service }}");
            sb.AppendLine($@"from './{ dllTypeInfoModels.Name.ToLower() }.service';");
            sb.AppendLine(@"");
            ...
            sb.AppendLine(@"    }");
            sb.AppendLine(@"");
            sb.AppendLine($@"    { dllTypeInfoModels.Name.ToLower() }Service.Update{ dllTypeInfoModels.Name }Text({ dllTypeInfoModels.Name.ToLower() }TextModel);");
            sb.AppendLine(@"}");
            ...
            FileInfo fiOutputGen = new FileInfo(Config.GetValue<string>("LocalesFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
            ...
            fiOutputGen = new FileInfo(Config.GetValue<string>("LocalesFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
