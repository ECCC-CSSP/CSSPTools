...
namespace AngularComponentsGeneratedServices.Services
{
    ...
    {
        private void CreateRoutingModuleFile(DLLTypeInfo dllTypeInfoModels, List<DLLTypeInfo> DLLTypeInfoCSSPModelsList)
        {
            ...
            fiOutputGen = new FileInfo(Config.GetValue<string>("RoutingModuleFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
