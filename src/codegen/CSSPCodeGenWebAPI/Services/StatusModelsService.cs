...
{
    public class StatusModelsService : IStatusModelsService
    {
        /// <summary>
        ...
        /// <returns></returns>
        public async Task StatusModels(string command, CultureInfo culture, IConfiguration configuration, IStatusAndResultsService statusAndResultsService)
        {
