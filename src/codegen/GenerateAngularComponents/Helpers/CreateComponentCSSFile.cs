...
namespace GenerateAngularComponents
{
    ...
    {
        private void CreateComponentCSSFile(DLLTypeInfo dllTypeInfoModels, List<DLLTypeInfo> DLLTypeInfoCSSPDBModelsList)
        {
            ...
            FileInfo fiOutputGen = new FileInfo(Configuration.GetValue<string>("ComponentCSSFileName").Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()).Replace("{TypeNameLower}", dllTypeInfoModels.Name.ToLower()));
