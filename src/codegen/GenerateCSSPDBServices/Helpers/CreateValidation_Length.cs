                    ...
                    case "Double":
                        {
                            ...
                            else if (csspProp.Min != null && csspProp.Max != null)
                            {
                                ...
                                else
                                {
                                    if (csspProp.IsNullable)
                                    {
                                        ...
                                        sb.AppendLine(@"                {");
                                        sb.AppendLine($@"                    ValidationResults.Add(new ValidationResult(string.Format(CSSPCultureServicesRes._ValueShouldBeBetween_And_, ""{ csspProp.PropName }"", ""{ csspProp.Min.ToString() }"", ""{ csspProp.Max.ToString() }""), new[] {{ nameof({ TypeNameLower }.{ csspProp.PropName }) }}));");
                                        sb.AppendLine(@"                }");
                                        sb.AppendLine(@"            }");
                                        sb.AppendLine(@"");
                                    }
                            ...
                            else if (csspProp.Min != null)
                            {
                                if (csspProp.IsNullable)
                                {
                                    ...
                                    sb.AppendLine(@"                {");
                                    sb.AppendLine($@"                    ValidationResults.Add(new ValidationResult(string.Format(CSSPCultureServicesRes._MinValueIs_, ""{ csspProp.PropName }"", ""{ csspProp.Min.ToString() }""), new[] {{ nameof({ TypeNameLower }.{ csspProp.PropName }) }}));");
                                    sb.AppendLine(@"                }");
                                    sb.AppendLine(@"            }");
                                    sb.AppendLine(@"");
                                }
                            ...
                            else if (csspProp.Max != null)
                            {
                                if (csspProp.IsNullable)
                                {
                                    ...
                                    sb.AppendLine(@"                {");
                                    sb.AppendLine($@"                    ValidationResults.Add(new ValidationResult(string.Format(CSSPCultureServicesRes._MaxValueIs_, ""{ csspProp.PropName }"", ""{ csspProp.Max.ToString() }""), new[] {{ nameof({ TypeNameLower }.{ csspProp.PropName }) }}));");
                                    sb.AppendLine(@"                }");
                                    sb.AppendLine(@"            }");
                                    sb.AppendLine(@"");
                                }
                    ...
                    case "String":
                        {
                            ...
                            else if (csspProp.Min != null && csspProp.Max != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    sb.AppendLine(@"            {");
                                    sb.AppendLine($@"                ValidationResults.Add(new ValidationResult(string.Format(CSSPCultureServicesRes._LengthShouldBeBetween_And_, ""{ csspProp.PropName }"", ""{ csspProp.Min.ToString() }"", ""{ csspProp.Max.ToString() }""), new[] {{ nameof({ TypeNameLower }.{ csspProp.PropName }) }}));");
                                    sb.AppendLine(@"            }");
                                    sb.AppendLine(@"");
                                }
                            }
                            else if (csspProp.Min != null)
                            {
                                ...
                                sb.AppendLine(@"            {");
                                sb.AppendLine($@"                ValidationResults.Add(new ValidationResult(string.Format(CSSPCultureServicesRes._MinLengthIs_, ""{ csspProp.PropName }"", ""{ csspProp.Min.ToString() }""), new[] {{ nameof({ TypeNameLower }.{ csspProp.PropName }) }}));");
                                sb.AppendLine(@"            }");
                                sb.AppendLine(@"");
                            }
                            else if (csspProp.Max != null)
                            {
                                ...
                                sb.AppendLine(@"            {");
                                sb.AppendLine($@"                ValidationResults.Add(new ValidationResult(string.Format(CSSPCultureServicesRes._MaxLengthIs_, ""{ csspProp.PropName }"", ""{ csspProp.Max.ToString() }""), new[] {{ nameof({ TypeNameLower }.{ csspProp.PropName }) }}));");
                                sb.AppendLine(@"            }");
                                sb.AppendLine(@"");
                            }
                            else
