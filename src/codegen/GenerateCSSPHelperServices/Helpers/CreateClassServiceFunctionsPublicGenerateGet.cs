...
namespace GenerateCSSPHelperServices
{
    ...
    {
        private async Task<bool> CreateClassServiceFunctionsPublicGenerateGet(DLLTypeInfo dllTypeInfo, List<DLLTypeInfo> DLLTypeInfoCSSPHelperModelsList, string TypeName, string TypeNameLower, StringBuilder sb)
        {
            ...
            foreach (DLLPropertyInfo dllPropertyInfo in dllTypeInfo.PropertyInfoList)
            {
                ...
                if (csspProp.IsKey)
                {
                    ...
                    foreach (DLLTypeInfo dllTypeInfo2 in DLLTypeInfoCSSPHelperModelsList)
                    {
