using GenerateCodeRun.Resources;
...
{
    public partial class GenerateCodeRunService : IGenerateCodeRunService
    {
        #region Variables
        ...
        #region Constructors
        public GenerateCodeRunService(IConfigurationRoot configuration, IGenerateCodeStatusDBService generateCodeStatusDBService)
        {
        ...
        public async Task Run(string FileNameToRun)
        {
            string LogFileName = "RunLog.txt";
            FileInfo fi = new FileInfo(FileNameToRun);
            ...
            string arg = $" run /flp:v=m; /flp:logfile={ LogFileName }";
