...
using GenerateCodeTest.Resources;
...
{
    public partial class GenerateCodeTestService : IGenerateCodeTestService
    {
        #region Variables
        ...
        #region Constructors
        public GenerateCodeTestService(IConfigurationRoot configuration, IGenerateCodeStatusDBService generateCodeStatusDBService)
        {
        ...
        public async Task Test(string FileNameToTest)
        {
            string LogFileName = "TestLog.txt";
            FileInfo fi = new FileInfo(FileNameToTest);
            ...
            string arg = $" test /flp:v=m; /flp:logfile={ LogFileName }";
