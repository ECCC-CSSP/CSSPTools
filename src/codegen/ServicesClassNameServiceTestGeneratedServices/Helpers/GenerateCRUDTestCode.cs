...
namespace ServicesClassNameServiceTestGeneratedServices.Services
{
    public partial class ServicesClassNameServiceTestGeneratedService : IServicesClassNameServiceTestGeneratedService
    {
        ...
        {
            sb.AppendLine($@"        #region Tests Generated Constructor [{ DBType }]");
            sb.AppendLine(@"        [Theory]");
            sb.AppendLine(@"        [InlineData(""en-CA"")]");
            sb.AppendLine(@"        //[InlineData(""fr-CA"")]");
            sb.AppendLine($@"        public async Task { TypeName }{ DBType }_Constructor_Good_Test(string culture)");
            sb.AppendLine(@"        {");
            sb.AppendLine(@"            Assert.True(await Setup(culture));");
            sb.AppendLine(@"        }");
            sb.AppendLine($@"        #endregion Tests Generated Constructor [{ DBType }]");
            sb.AppendLine(@"");
            ...
            sb.AppendLine(@"        }");
            sb.AppendLine($@"        #endregion Tests Generated [{ DBType }] CRUD");
            sb.AppendLine(@"");
