...
namespace CSSPAzureAppTaskModelServices
{
    ...
    {
        private bool ValidateAzureAddOrModifyAppTaskModel(ValidationContext validationContext)
        {
            ValidationResults = new List<ValidationResult>();

            AppTaskModel appTaskModel = validationContext.ObjectInstance as AppTaskModel;
