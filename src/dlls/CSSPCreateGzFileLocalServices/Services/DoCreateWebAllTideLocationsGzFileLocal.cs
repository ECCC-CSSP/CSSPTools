...
namespace CreateGzFileLocalServices
{
    ...
    {
        private async Task<ActionResult<bool>> DoCreateWebAllTideLocationsGzFileLocal()
        {
            ...
            try
            {
                ...
                DoStoreLocal<WebAllTideLocations>(webAllTideLocations, $"{ WebTypeEnum.WebAllTideLocations }.gz");
            }
            catch (Exception ex)
            {
