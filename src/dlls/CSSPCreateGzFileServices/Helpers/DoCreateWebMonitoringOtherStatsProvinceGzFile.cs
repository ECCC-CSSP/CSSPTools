...
namespace CreateGzFileServices
{
    ...
    {
        private async Task<bool> DoCreateWebMonitoringOtherStatsProvinceGzFile(int ProvinceTVItemID)
        {
            ...
            List<TVItemLanguage> tvItemLanguageProvinceTestList = await GetTVItemLanguageWithTVItemID(ProvinceTVItemID);
            ...
            try
            {
                if (dbLocal != null)
                {
                    if (!await DoStoreLocal<WebMonitoringOtherStatsProvince>(webMonitoringOtherStatsProvince, $"{ WebTypeEnum.WebMonitoringOtherStatsProvince }_{tvItemProv.TVItemID}.gz")) return await Task .FromResult(false);
                }
                else
                {
                    if (!await DoStore<WebMonitoringOtherStatsProvince>(webMonitoringOtherStatsProvince, $"{ WebTypeEnum.WebMonitoringOtherStatsProvince }_{tvItemProv.TVItemID}.gz")) return await Task .FromResult(false);
                }
