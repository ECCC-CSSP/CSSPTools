...
namespace CSSPCreateGzFileServices
{
    ...
    {
        private async Task<bool> FillClassificationModelList(List<ClassificationModel> ClassificationModelList, TVItem TVItem, TVTypeEnum TVType)
        {
            ...
            List<Classification> ClassificationList = await GetClassificationListFromSubsector(TVItem);
