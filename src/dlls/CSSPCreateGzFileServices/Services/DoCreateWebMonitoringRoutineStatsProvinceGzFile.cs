...
namespace CreateGzFileServices
{
    ...
    {
        private async Task<ActionResult<bool>> DoCreateWebMonitoringRoutineStatsProvinceGzFile(int ProvinceTVItemID)
        {
            ...
            try
            {
                if (dbLocal != null)
                {
                    await DoStoreLocal<WebMonitoringRoutineStatsProvince>(webMonitoringRoutineStatsProvince, $"{ WebTypeEnum.WebMonitoringRoutineStatsProvince }_{tvItemProv.TVItemID}.gz");
                }
                else
                {
                    await DoStore<WebMonitoringRoutineStatsProvince>(webMonitoringRoutineStatsProvince, $"{ WebTypeEnum.WebMonitoringRoutineStatsProvince }_{tvItemProv.TVItemID}.gz");
                }
