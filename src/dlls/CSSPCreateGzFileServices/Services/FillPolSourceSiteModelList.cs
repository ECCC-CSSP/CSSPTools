...
namespace CreateGzFileServices
{
    ...
    {
        private async Task FillPolSourceSiteModelList(List<PolSourceSiteModel> PolSourceSiteModelList, TVItem TVItem, TVTypeEnum TVType)
        {
            ...
            foreach (TVItem tvItem in TVItemList)
            {
                ...
                polSourceSiteModel.TVItemStatMapModel = tvItemStatMapModel;
