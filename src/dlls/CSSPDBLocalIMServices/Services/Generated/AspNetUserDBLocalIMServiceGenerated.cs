...
{
    public partial interface IAspNetUserDBLocalIMService
    {
    ...
    public partial class AspNetUserDBLocalIMService : ControllerBase, IAspNetUserDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public AspNetUserDBLocalIMService(ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<AspNetUser>> GetAspNetUserWithId(string Id)
        {
            ...
            AspNetUser aspNetUser = (from c in dbLocalIM.AspNetUsers.AsNoTracking()
                    where c.Id == Id
        ...
        public async Task<ActionResult<List<AspNetUser>>> GetAspNetUserList(int skip = 0, int take = 100)
        {
            ...
            List<AspNetUser> aspNetUserList = (from c in dbLocalIM.AspNetUsers.AsNoTracking() orderby c.Email select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(string Id)
        {
            ...
            AspNetUser aspNetUser = (from c in dbLocalIM.AspNetUsers
                    where c.Id == Id
                    select c).FirstOrDefault();
            ...
            try
            {
                dbLocalIM.AspNetUsers.Remove(aspNetUser);
        ...
        public async Task<ActionResult<AspNetUser>> Post(AspNetUser aspNetUser)
        {
            ...
            try
            {
                dbLocalIM.AspNetUsers.Add(aspNetUser);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        public async Task<ActionResult<AspNetUser>> Put(AspNetUser aspNetUser)
        {
            ...
            try
            {
                dbLocalIM.AspNetUsers.Update(aspNetUser);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.AspNetUsers select c).Where(c => c.Id == aspNetUser.Id).Any())
                {
