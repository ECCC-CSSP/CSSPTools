...
{
    public partial interface IBoxModelResultDBLocalIMService
    {
    ...
    public partial class BoxModelResultDBLocalIMService : ControllerBase, IBoxModelResultDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public BoxModelResultDBLocalIMService(IConfiguration Configuration, ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<BoxModelResult>> GetBoxModelResultWithBoxModelResultID(int BoxModelResultID)
        {
            ...
            BoxModelResult boxModelResult = (from c in dbLocalIM.BoxModelResults.AsNoTracking()
        ...
        public async Task<ActionResult<List<BoxModelResult>>> GetBoxModelResultList(int skip = 0, int take = 100)
        {
            ...
            List<BoxModelResult> boxModelResultList = (from c in dbLocalIM.BoxModelResults.AsNoTracking() orderby c.BoxModelResultID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int BoxModelResultID)
        {
            ...
            BoxModelResult boxModelResult = (from c in dbLocalIM.BoxModelResults
                    where c.BoxModelResultID == BoxModelResultID
                    select c).FirstOrDefault();
            ...
            try
            {
                dbLocalIM.BoxModelResults.Remove(boxModelResult);
        ...
        public async Task<ActionResult<BoxModelResult>> Post(BoxModelResult boxModelResult)
        {
            ...
            try
            {
                dbLocalIM.BoxModelResults.Add(boxModelResult);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        public async Task<ActionResult<BoxModelResult>> Put(BoxModelResult boxModelResult)
        {
            ...
            try
            {
                dbLocalIM.BoxModelResults.Update(boxModelResult);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.BoxModelResults select c).Where(c => c.BoxModelResultID == boxModelResult.BoxModelResultID).Any())
                {
            ...
            BoxModelBoxModelID = (from c in dbLocalIM.BoxModels where c.BoxModelID == boxModelResult.BoxModelID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == boxModelResult.LastUpdateContactTVItemID select c).FirstOrDefault();
