...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class ClimateSiteDBLocalIMService : ControllerBase, IClimateSiteDBLocalIMService
    {
        ...
        public async Task<ActionResult<ClimateSite>> GetClimateSiteWithClimateSiteID(int ClimateSiteID)
        {
            ...
            ClimateSite climateSite = (from c in dbLocalIM.ClimateSites.AsNoTracking()
        ...
        public async Task<ActionResult<List<ClimateSite>>> GetClimateSiteList(int skip = 0, int take = 100)
        {
            ...
            List<ClimateSite> climateSiteList = (from c in dbLocalIM.ClimateSites.AsNoTracking() orderby c.ClimateSiteID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int ClimateSiteID)
        {
            ...
            ClimateSite climateSite = (from c in dbLocalIM.ClimateSites
                    where c.ClimateSiteID == ClimateSiteID
                    select c).FirstOrDefault();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.ClimateSites select c).Where(c => c.ClimateSiteID == climateSite.ClimateSiteID).Any())
                {
            ...
            TVItemClimateSiteTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == climateSite.ClimateSiteTVItemID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == climateSite.LastUpdateContactTVItemID select c).FirstOrDefault();
