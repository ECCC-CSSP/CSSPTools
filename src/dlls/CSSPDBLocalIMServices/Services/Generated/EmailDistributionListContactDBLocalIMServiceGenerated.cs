...
{
    public partial interface IEmailDistributionListContactDBLocalIMService
    {
    ...
    public partial class EmailDistributionListContactDBLocalIMService : ControllerBase, IEmailDistributionListContactDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public EmailDistributionListContactDBLocalIMService(IConfiguration Configuration, ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<EmailDistributionListContact>> GetEmailDistributionListContactWithEmailDistributionListContactID(int EmailDistributionListContactID)
        {
            ...
            EmailDistributionListContact emailDistributionListContact = (from c in dbLocalIM.EmailDistributionListContacts.AsNoTracking()
        ...
        public async Task<ActionResult<List<EmailDistributionListContact>>> GetEmailDistributionListContactList(int skip = 0, int take = 100)
        {
            ...
            List<EmailDistributionListContact> emailDistributionListContactList = (from c in dbLocalIM.EmailDistributionListContacts.AsNoTracking() orderby c.EmailDistributionListContactID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int EmailDistributionListContactID)
        {
            ...
            EmailDistributionListContact emailDistributionListContact = (from c in dbLocalIM.EmailDistributionListContacts
                    where c.EmailDistributionListContactID == EmailDistributionListContactID
                    select c).FirstOrDefault();
            ...
            try
            {
                dbLocalIM.EmailDistributionListContacts.Remove(emailDistributionListContact);
        ...
        public async Task<ActionResult<EmailDistributionListContact>> Post(EmailDistributionListContact emailDistributionListContact)
        {
            ...
            try
            {
                dbLocalIM.EmailDistributionListContacts.Add(emailDistributionListContact);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        public async Task<ActionResult<EmailDistributionListContact>> Put(EmailDistributionListContact emailDistributionListContact)
        {
            ...
            try
            {
                dbLocalIM.EmailDistributionListContacts.Update(emailDistributionListContact);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.EmailDistributionListContacts select c).Where(c => c.EmailDistributionListContactID == emailDistributionListContact.EmailDistributionListContactID).Any())
                {
            ...
            EmailDistributionListEmailDistributionListID = (from c in dbLocalIM.EmailDistributionLists where c.EmailDistributionListID == emailDistributionListContact.EmailDistributionListID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == emailDistributionListContact.LastUpdateContactTVItemID select c).FirstOrDefault();
