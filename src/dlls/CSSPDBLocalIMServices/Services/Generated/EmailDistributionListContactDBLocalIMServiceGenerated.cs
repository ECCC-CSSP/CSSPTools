...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class EmailDistributionListContactDBLocalIMService : ControllerBase, IEmailDistributionListContactDBLocalIMService
    {
        ...
        public async Task<ActionResult<EmailDistributionListContact>> GetEmailDistributionListContactWithEmailDistributionListContactID(int EmailDistributionListContactID)
        {
            ...
            EmailDistributionListContact emailDistributionListContact = (from c in dbLocalIM.EmailDistributionListContacts.Local
        ...
        public async Task<ActionResult<List<EmailDistributionListContact>>> GetEmailDistributionListContactList(int skip = 0, int take = 100)
        {
            ...
            List<EmailDistributionListContact> emailDistributionListContactList = (from c in dbLocalIM.EmailDistributionListContacts.Local orderby c.EmailDistributionListContactID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.EmailDistributionListContacts.Local select c).Where(c => c.EmailDistributionListContactID == emailDistributionListContact.EmailDistributionListContactID).Any())
                {
