...
{
    public partial interface ILogDBLocalIMService
    {
    ...
    public partial class LogDBLocalIMService : ControllerBase, ILogDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public LogDBLocalIMService(IConfiguration Configuration, ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<Log>> GetLogWithLogID(int LogID)
        {
            ...
            Log log = (from c in dbLocalIM.Logs.AsNoTracking()
                    where c.LogID == LogID
        ...
        public async Task<ActionResult<List<Log>>> GetLogList(int skip = 0, int take = 100)
        {
            ...
            List<Log> logList = (from c in dbLocalIM.Logs.AsNoTracking() orderby c.LogID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int LogID)
        {
            ...
            Log log = (from c in dbLocalIM.Logs
                    where c.LogID == LogID
                    select c).FirstOrDefault();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.Logs select c).Where(c => c.LogID == log.LogID).Any())
                {
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == log.LastUpdateContactTVItemID select c).FirstOrDefault();
