...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class MWQMSubsectorDBLocalIMService : ControllerBase, IMWQMSubsectorDBLocalIMService
    {
        ...
        public async Task<ActionResult<MWQMSubsector>> GetMWQMSubsectorWithMWQMSubsectorID(int MWQMSubsectorID)
        {
            ...
            MWQMSubsector mwqmSubsector = (from c in dbLocalIM.MWQMSubsectors.Local
        ...
        public async Task<ActionResult<List<MWQMSubsector>>> GetMWQMSubsectorList(int skip = 0, int take = 100)
        {
            ...
            List<MWQMSubsector> mwqmSubsectorList = (from c in dbLocalIM.MWQMSubsectors.Local orderby c.MWQMSubsectorID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.MWQMSubsectors.Local select c).Where(c => c.MWQMSubsectorID == mwqmSubsector.MWQMSubsectorID).Any())
                {
