...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class MikeSourceStartEndDBLocalIMService : ControllerBase, IMikeSourceStartEndDBLocalIMService
    {
        ...
        public async Task<ActionResult<MikeSourceStartEnd>> GetMikeSourceStartEndWithMikeSourceStartEndID(int MikeSourceStartEndID)
        {
            ...
            MikeSourceStartEnd mikeSourceStartEnd = (from c in dbLocalIM.MikeSourceStartEnds.AsNoTracking()
        ...
        public async Task<ActionResult<List<MikeSourceStartEnd>>> GetMikeSourceStartEndList(int skip = 0, int take = 100)
        {
            ...
            List<MikeSourceStartEnd> mikeSourceStartEndList = (from c in dbLocalIM.MikeSourceStartEnds.AsNoTracking() orderby c.MikeSourceStartEndID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int MikeSourceStartEndID)
        {
            ...
            MikeSourceStartEnd mikeSourceStartEnd = (from c in dbLocalIM.MikeSourceStartEnds
                    where c.MikeSourceStartEndID == MikeSourceStartEndID
                    select c).FirstOrDefault();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.MikeSourceStartEnds select c).Where(c => c.MikeSourceStartEndID == mikeSourceStartEnd.MikeSourceStartEndID).Any())
                {
            ...
            MikeSourceMikeSourceID = (from c in dbLocalIM.MikeSources where c.MikeSourceID == mikeSourceStartEnd.MikeSourceID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == mikeSourceStartEnd.LastUpdateContactTVItemID select c).FirstOrDefault();
