...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class PolSourceSiteDBLocalIMService : ControllerBase, IPolSourceSiteDBLocalIMService
    {
        ...
        public async Task<ActionResult<PolSourceSite>> GetPolSourceSiteWithPolSourceSiteID(int PolSourceSiteID)
        {
            ...
            PolSourceSite polSourceSite = (from c in dbLocalIM.PolSourceSites.AsNoTracking()
        ...
        public async Task<ActionResult<List<PolSourceSite>>> GetPolSourceSiteList(int skip = 0, int take = 100)
        {
            ...
            List<PolSourceSite> polSourceSiteList = (from c in dbLocalIM.PolSourceSites.AsNoTracking() orderby c.PolSourceSiteID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int PolSourceSiteID)
        {
            ...
            PolSourceSite polSourceSite = (from c in dbLocalIM.PolSourceSites
                    where c.PolSourceSiteID == PolSourceSiteID
                    select c).FirstOrDefault();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.PolSourceSites select c).Where(c => c.PolSourceSiteID == polSourceSite.PolSourceSiteID).Any())
                {
            ...
            TVItemPolSourceSiteTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == polSourceSite.PolSourceSiteTVItemID select c).FirstOrDefault();
            ...
            if (polSourceSite.CivicAddressTVItemID != null)
            {
                ...
                TVItemCivicAddressTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == polSourceSite.CivicAddressTVItemID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == polSourceSite.LastUpdateContactTVItemID select c).FirstOrDefault();
