...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class RatingCurveDBLocalIMService : ControllerBase, IRatingCurveDBLocalIMService
    {
        ...
        public async Task<ActionResult<RatingCurve>> GetRatingCurveWithRatingCurveID(int RatingCurveID)
        {
            ...
            RatingCurve ratingCurve = (from c in dbLocalIM.RatingCurves.Local
        ...
        public async Task<ActionResult<List<RatingCurve>>> GetRatingCurveList(int skip = 0, int take = 100)
        {
            ...
            List<RatingCurve> ratingCurveList = (from c in dbLocalIM.RatingCurves.Local orderby c.RatingCurveID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.RatingCurves.Local select c).Where(c => c.RatingCurveID == ratingCurve.RatingCurveID).Any())
                {
