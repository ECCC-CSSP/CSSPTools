...
{
    public partial interface IResetPasswordDBLocalIMService
    {
    ...
    public partial class ResetPasswordDBLocalIMService : ControllerBase, IResetPasswordDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public ResetPasswordDBLocalIMService(IConfiguration Configuration, ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<ResetPassword>> GetResetPasswordWithResetPasswordID(int ResetPasswordID)
        {
            ...
            ResetPassword resetPassword = (from c in dbLocalIM.ResetPasswords.AsNoTracking()
        ...
        public async Task<ActionResult<List<ResetPassword>>> GetResetPasswordList(int skip = 0, int take = 100)
        {
            ...
            List<ResetPassword> resetPasswordList = (from c in dbLocalIM.ResetPasswords.AsNoTracking() orderby c.ResetPasswordID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int ResetPasswordID)
        {
            ...
            ResetPassword resetPassword = (from c in dbLocalIM.ResetPasswords
                    where c.ResetPasswordID == ResetPasswordID
                    select c).FirstOrDefault();
            ...
            try
            {
                dbLocalIM.ResetPasswords.Remove(resetPassword);
        ...
        public async Task<ActionResult<ResetPassword>> Post(ResetPassword resetPassword)
        {
            ...
            try
            {
                dbLocalIM.ResetPasswords.Add(resetPassword);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        public async Task<ActionResult<ResetPassword>> Put(ResetPassword resetPassword)
        {
            ...
            try
            {
                dbLocalIM.ResetPasswords.Update(resetPassword);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.ResetPasswords select c).Where(c => c.ResetPasswordID == resetPassword.ResetPasswordID).Any())
                {
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == resetPassword.LastUpdateContactTVItemID select c).FirstOrDefault();
