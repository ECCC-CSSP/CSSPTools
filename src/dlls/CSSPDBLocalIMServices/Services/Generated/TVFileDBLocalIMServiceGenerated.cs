...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class TVFileDBLocalIMService : ControllerBase, ITVFileDBLocalIMService
    {
        ...
        public async Task<ActionResult<TVFile>> GetTVFileWithTVFileID(int TVFileID)
        {
            ...
            TVFile tvFile = (from c in dbLocalIM.TVFiles.Local
        ...
        public async Task<ActionResult<List<TVFile>>> GetTVFileList(int skip = 0, int take = 100)
        {
            ...
            List<TVFile> tvFileList = (from c in dbLocalIM.TVFiles.Local orderby c.TVFileID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.TVFiles.Local select c).Where(c => c.TVFileID == tvFile.TVFileID).Any())
                {
