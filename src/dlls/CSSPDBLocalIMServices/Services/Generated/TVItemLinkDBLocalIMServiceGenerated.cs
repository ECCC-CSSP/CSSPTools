...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class TVItemLinkDBLocalIMService : ControllerBase, ITVItemLinkDBLocalIMService
    {
        ...
        public async Task<ActionResult<TVItemLink>> GetTVItemLinkWithTVItemLinkID(int TVItemLinkID)
        {
            ...
            TVItemLink tvItemLink = (from c in dbLocalIM.TVItemLinks.Local
        ...
        public async Task<ActionResult<List<TVItemLink>>> GetTVItemLinkList(int skip = 0, int take = 100)
        {
            ...
            List<TVItemLink> tvItemLinkList = (from c in dbLocalIM.TVItemLinks.Local orderby c.TVItemLinkID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.TVItemLinks.Local select c).Where(c => c.TVItemLinkID == tvItemLink.TVItemLinkID).Any())
                {
