...
{
    public partial interface ITVTypeUserAuthorizationDBLocalIMService
    {
    ...
    public partial class TVTypeUserAuthorizationDBLocalIMService : ControllerBase, ITVTypeUserAuthorizationDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public TVTypeUserAuthorizationDBLocalIMService(ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<TVTypeUserAuthorization>> GetTVTypeUserAuthorizationWithTVTypeUserAuthorizationID(int TVTypeUserAuthorizationID)
        {
            ...
            TVTypeUserAuthorization tvTypeUserAuthorization = (from c in dbLocalIM.TVTypeUserAuthorizations.AsNoTracking()
        ...
        public async Task<ActionResult<List<TVTypeUserAuthorization>>> GetTVTypeUserAuthorizationList(int skip = 0, int take = 100)
        {
            ...
            List<TVTypeUserAuthorization> tvTypeUserAuthorizationList = (from c in dbLocalIM.TVTypeUserAuthorizations.AsNoTracking() orderby c.TVTypeUserAuthorizationID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int TVTypeUserAuthorizationID)
        {
            ...
            TVTypeUserAuthorization tvTypeUserAuthorization = (from c in dbLocalIM.TVTypeUserAuthorizations
                    where c.TVTypeUserAuthorizationID == TVTypeUserAuthorizationID
                    select c).FirstOrDefault();
            ...
            try
            {
                dbLocalIM.TVTypeUserAuthorizations.Remove(tvTypeUserAuthorization);
        ...
        public async Task<ActionResult<TVTypeUserAuthorization>> Post(TVTypeUserAuthorization tvTypeUserAuthorization)
        {
            ...
            try
            {
                dbLocalIM.TVTypeUserAuthorizations.Add(tvTypeUserAuthorization);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        public async Task<ActionResult<TVTypeUserAuthorization>> Put(TVTypeUserAuthorization tvTypeUserAuthorization)
        {
            ...
            try
            {
                dbLocalIM.TVTypeUserAuthorizations.Update(tvTypeUserAuthorization);
                dbLocalIM.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.TVTypeUserAuthorizations select c).Where(c => c.TVTypeUserAuthorizationID == tvTypeUserAuthorization.TVTypeUserAuthorizationID).Any())
                {
            ...
            TVItemContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == tvTypeUserAuthorization.ContactTVItemID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == tvTypeUserAuthorization.LastUpdateContactTVItemID select c).FirstOrDefault();
