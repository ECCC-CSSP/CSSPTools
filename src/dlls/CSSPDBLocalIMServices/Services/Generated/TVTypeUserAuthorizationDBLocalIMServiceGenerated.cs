...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class TVTypeUserAuthorizationDBLocalIMService : ControllerBase, ITVTypeUserAuthorizationDBLocalIMService
    {
        ...
        public async Task<ActionResult<TVTypeUserAuthorization>> GetTVTypeUserAuthorizationWithTVTypeUserAuthorizationID(int TVTypeUserAuthorizationID)
        {
            ...
            TVTypeUserAuthorization tvTypeUserAuthorization = (from c in dbLocalIM.TVTypeUserAuthorizations.Local
        ...
        public async Task<ActionResult<List<TVTypeUserAuthorization>>> GetTVTypeUserAuthorizationList(int skip = 0, int take = 100)
        {
            ...
            List<TVTypeUserAuthorization> tvTypeUserAuthorizationList = (from c in dbLocalIM.TVTypeUserAuthorizations.Local orderby c.TVTypeUserAuthorizationID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.TVTypeUserAuthorizations.Local select c).Where(c => c.TVTypeUserAuthorizationID == tvTypeUserAuthorization.TVTypeUserAuthorizationID).Any())
                {
