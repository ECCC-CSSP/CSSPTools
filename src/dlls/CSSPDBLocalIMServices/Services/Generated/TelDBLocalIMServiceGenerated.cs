...
{
    public partial interface ITelDBLocalIMService
    {
    ...
    public partial class TelDBLocalIMService : ControllerBase, ITelDBLocalIMService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public TelDBLocalIMService(IConfiguration Configuration, ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<Tel>> GetTelWithTelID(int TelID)
        {
            ...
            Tel tel = (from c in dbLocalIM.Tels.AsNoTracking()
                    where c.TelID == TelID
        ...
        public async Task<ActionResult<List<Tel>>> GetTelList(int skip = 0, int take = 100)
        {
            ...
            List<Tel> telList = (from c in dbLocalIM.Tels.AsNoTracking() orderby c.TelID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int TelID)
        {
            ...
            Tel tel = (from c in dbLocalIM.Tels
                    where c.TelID == TelID
                    select c).FirstOrDefault();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.Tels select c).Where(c => c.TelID == tel.TelID).Any())
                {
            ...
            TVItemTelTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == tel.TelTVItemID select c).FirstOrDefault();
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems where c.TVItemID == tel.LastUpdateContactTVItemID select c).FirstOrDefault();
