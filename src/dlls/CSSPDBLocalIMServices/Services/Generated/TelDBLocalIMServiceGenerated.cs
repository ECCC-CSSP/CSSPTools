...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class TelDBLocalIMService : ControllerBase, ITelDBLocalIMService
    {
        ...
        public async Task<ActionResult<Tel>> GetTelWithTelID(int TelID)
        {
            ...
            Tel tel = (from c in dbLocalIM.Tels.Local
                    where c.TelID == TelID
        ...
        public async Task<ActionResult<List<Tel>>> GetTelList(int skip = 0, int take = 100)
        {
            ...
            List<Tel> telList = (from c in dbLocalIM.Tels.Local orderby c.TelID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.Tels.Local select c).Where(c => c.TelID == tel.TelID).Any())
                {
