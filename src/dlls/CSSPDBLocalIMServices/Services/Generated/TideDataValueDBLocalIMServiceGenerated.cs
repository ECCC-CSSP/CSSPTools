...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class TideDataValueDBLocalIMService : ControllerBase, ITideDataValueDBLocalIMService
    {
        ...
        public async Task<ActionResult<TideDataValue>> GetTideDataValueWithTideDataValueID(int TideDataValueID)
        {
            ...
            TideDataValue tideDataValue = (from c in dbLocalIM.TideDataValues.Local
        ...
        public async Task<ActionResult<List<TideDataValue>>> GetTideDataValueList(int skip = 0, int take = 100)
        {
            ...
            List<TideDataValue> tideDataValueList = (from c in dbLocalIM.TideDataValues.Local orderby c.TideDataValueID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.TideDataValues.Local select c).Where(c => c.TideDataValueID == tideDataValue.TideDataValueID).Any())
                {
