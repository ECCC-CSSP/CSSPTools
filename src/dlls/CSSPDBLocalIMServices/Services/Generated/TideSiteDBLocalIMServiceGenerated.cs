...
namespace CSSPDBLocalIMServices
{
    ...
    public partial class TideSiteDBLocalIMService : ControllerBase, ITideSiteDBLocalIMService
    {
        ...
        public async Task<ActionResult<TideSite>> GetTideSiteWithTideSiteID(int TideSiteID)
        {
            ...
            TideSite tideSite = (from c in dbLocalIM.TideSites.Local
        ...
        public async Task<ActionResult<List<TideSite>>> GetTideSiteList(int skip = 0, int take = 100)
        {
            ...
            List<TideSite> tideSiteList = (from c in dbLocalIM.TideSites.Local orderby c.TideSiteID select c).Skip(skip).Take(take).ToList();
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocalIM.TideSites.Local select c).Where(c => c.TideSiteID == tideSite.TideSiteID).Any())
                {
