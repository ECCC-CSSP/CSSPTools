...
{
    public partial interface IAddressDBLocalService
    {
    ...
    public partial class AddressDBLocalService : ControllerBase, IAddressDBLocalService
    {
        #region Variables
        #endregion Variables
        ...
        public async Task<ActionResult<Address>> Post(Address address)
        {
            ...
            if (address.AddressID == 0)
            {
                ...
                address.AddressID = LastAddressID + 1;
            }
