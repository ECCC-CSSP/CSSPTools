/*
 * Auto generated from C:\CSSPTools\src\codegen\_package\net5.0\GenerateCSSPDBLocalServices.exe
 *
...
namespace CSSPDBLocalServices
{
    public partial interface IAddressDBService
    {
        ...
        Task<ActionResult<Address>> Post(TVItemModel tvItemModelParent, Address address);
        Task<ActionResult<Address>> Put(TVItemModel tvItemModelParent, Address address);
    }
    public partial class AddressDBService : ControllerBase, IAddressDBService
    {
        ...
        #region Constructors
        public AddressDBService(IConfiguration Configuration, ICSSPCultureService CSSPCultureService, ILoggedInService LoggedInService,
            IEnums enums, CSSPDBLocalContext dbLocal, IReadGzFileService ReadGzFileService)
        {
        ...
        public async Task<ActionResult<Address>> Post(TVItemModel tvItemModelParent, Address address)
        {
            if (LoggedInService.LoggedInContactInfo.LoggedInContact == null)
            {
                return await Task.FromResult(Unauthorized());
            ...
            WebAllCountries webAllCountries = await ReadGzFileService.GetUncompressJSON<WebAllCountries>(WebTypeEnum.WebAllCountries, 0, WebTypeYearEnum.Year1980);
            WebAllProvinces webAllProvinces = await ReadGzFileService.GetUncompressJSON<WebAllProvinces>(WebTypeEnum.WebAllCountries, 0, WebTypeYearEnum.Year1980);
            WebAllMunicipalities webAllMunicipalities = await ReadGzFileService.GetUncompressJSON<WebAllMunicipalities>(WebTypeEnum.WebAllCountries, 0, WebTypeYearEnum.Year1980);
            WebAllContacts webAllContacts = await ReadGzFileService.GetUncompressJSON<WebAllContacts>(WebTypeEnum.WebAllContacts, 0, WebTypeYearEnum.Year1980);
        ...
        public async Task<ActionResult<Address>> Put(TVItemModel tvItemModelParent, Address address)
        {
            if (LoggedInService.LoggedInContactInfo.LoggedInContact == null)
            {
                return await Task.FromResult(Unauthorized());
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            {
                yield return new ValidationResult(string.Format(CSSPCultureServicesRes._IsRequired, "DBCommand"), new[] { nameof(address.DBCommand) });
            }
