...
{
    public partial interface IMWQMAnalysisReportParameterDBLocalService
    {
    ...
    public partial class MWQMAnalysisReportParameterDBLocalService : ControllerBase, IMWQMAnalysisReportParameterDBLocalService
    {
        #region Variables
        #endregion Variables
        ...
        public async Task<ActionResult<MWQMAnalysisReportParameter>> Post(MWQMAnalysisReportParameter mwqmAnalysisReportParameter)
        {
            ...
            if (mwqmAnalysisReportParameter.MWQMAnalysisReportParameterID == 0)
            {
                ...
                mwqmAnalysisReportParameter.MWQMAnalysisReportParameterID = LastMWQMAnalysisReportParameterID + 1;
            }
