...
{
    public partial interface IRainExceedanceDBLocalService
    {
    ...
    public partial class RainExceedanceDBLocalService : ControllerBase, IRainExceedanceDBLocalService
    {
        #region Variables
        #endregion Variables
        ...
        public async Task<ActionResult<RainExceedance>> Post(RainExceedance rainExceedance)
        {
            ...
            if (rainExceedance.RainExceedanceID == 0)
            {
                ...
                rainExceedance.RainExceedanceID = LastRainExceedanceID + 1;
            }
