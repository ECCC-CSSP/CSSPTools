...
namespace CSSPDBLocalServices
{
    ...
    public partial class ReportTypeDBLocalService : ControllerBase, IReportTypeDBLocalService
    {
        ...
        public async Task<ActionResult<ReportType>> Post(ReportType reportType)
        {
            ...
            {
                int LastReportTypeID = (from c in dbLocal.ReportTypes.AsNoTracking()
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                if (!(from c in dbLocal.ReportTypes.AsNoTracking() select c).Where(c => c.ReportTypeID == reportType.ReportTypeID).Any())
                {
            ...
            TVItemLastUpdateContactTVItemID = (from c in dbLocal.TVItems.AsNoTracking() where c.TVItemID == reportType.LastUpdateContactTVItemID select c).FirstOrDefault();

            if (TVItemLastUpdateContactTVItemID == null)
            {
                TVItemLastUpdateContactTVItemID = (from c in dbLocalIM.TVItems.Local where c.TVItemID == reportType.LastUpdateContactTVItemID select c).FirstOrDefault();
