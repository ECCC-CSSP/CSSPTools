...
{
    public partial interface ISamplingPlanDBLocalService
    {
    ...
    public partial class SamplingPlanDBLocalService : ControllerBase, ISamplingPlanDBLocalService
    {
        #region Variables
        #endregion Variables
        ...
        public async Task<ActionResult<SamplingPlan>> Post(SamplingPlan samplingPlan)
        {
            ...
            if (samplingPlan.SamplingPlanID == 0)
            {
                ...
                samplingPlan.SamplingPlanID = LastSamplingPlanID + 1;
            }
