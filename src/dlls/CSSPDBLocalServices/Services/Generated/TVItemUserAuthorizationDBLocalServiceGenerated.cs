...
{
    public partial interface ITVItemUserAuthorizationDBLocalService
    {
    ...
    public partial class TVItemUserAuthorizationDBLocalService : ControllerBase, ITVItemUserAuthorizationDBLocalService
    {
        #region Variables
        #endregion Variables
        ...
        public async Task<ActionResult<TVItemUserAuthorization>> Post(TVItemUserAuthorization tvItemUserAuthorization)
        {
            ...
            if (tvItemUserAuthorization.TVItemUserAuthorizationID == 0)
            {
                ...
                tvItemUserAuthorization.TVItemUserAuthorizationID = LastTVItemUserAuthorizationID + 1;
            }
