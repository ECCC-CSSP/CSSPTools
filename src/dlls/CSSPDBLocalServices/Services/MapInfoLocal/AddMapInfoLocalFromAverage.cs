...
namespace CSSPDBLocalServices
{
    ...
    {
        public async Task<ActionResult<MapInfoModel>> AddMapInfoLocalFromAverage(TVItem tvItemParent, TVItem tvItem, TVTypeEnum tvType, MapInfoDrawTypeEnum mapInfoDrawType)
        {
            string parameters = "";
            ...
            MapInfoModel mapInfoModel = await GetMapInfoModelFromAverageSiblingList(mapInfoModelSiblingList, tvItem, tvType, mapInfoDrawType, await HelperLocalService.GetPolygonSize(tvType));
