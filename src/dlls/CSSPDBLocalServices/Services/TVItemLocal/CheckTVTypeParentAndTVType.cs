...
namespace CSSPDBLocalServices
{
    ...
    {
        private void CheckTVTypeParentAndTVType(TVTypeEnum tvTypeParent, TVTypeEnum tvType)
        {
            ...
            {
                CSSPLogService.AppendError(string.Format(CSSPCultureServicesRes._NotImplementedYet, tvTypeParent.ToString()) + " --- CSSPDBLocalServices.TVItemLocalService.CheckTVTypeParentAndTVType");
            }
            else
            {
