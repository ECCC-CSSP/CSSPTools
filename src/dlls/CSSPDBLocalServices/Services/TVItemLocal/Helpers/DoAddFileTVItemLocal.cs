...
namespace CSSPDBLocalServices
{
    ...
    public partial class TVItemLocalService : ControllerBase, ITVItemLocalService
    {
        ...
        //            || tvItemLocalModel.TVItemParent.TVType == TVTypeEnum.Infrastructure)
        //        {
        //            AppendToRecreateFile(tvItemLocalModel.TVItemParent.TVType, (int)tvItemLocalModel.TVItemParent.ParentID);
        //        }
        //        else
        //        {
        //            AppendToRecreateFile(tvItemLocalModel.TVItemParent.TVType, (int)tvItemLocalModel.TVItem.ParentID);
        //        }
        //    }
        //    catch (Exception ex)
        //    {
