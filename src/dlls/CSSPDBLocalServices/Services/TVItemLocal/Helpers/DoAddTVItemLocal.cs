...
namespace CSSPDBLocalServices
{
    ...
    {
        private async Task<bool> DoAddTVItemLocal(TVItemLocalModel tvItemLocalModel)
        {
            ...
            try
            {
                ...
                else if (tvItemNew.TVType == TVTypeEnum.MikeBoundaryConditionMesh || tvItemNew.TVType == TVTypeEnum.MikeBoundaryConditionWebTide || tvItemNew.TVType == TVTypeEnum.MikeSource)
                {
