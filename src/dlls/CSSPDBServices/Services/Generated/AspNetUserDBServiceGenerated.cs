...
{
    public partial interface IAspNetUserDBService
    {
    ...
    public partial class AspNetUserDBService : ControllerBase, IAspNetUserDBService
    {
        #region Variables
        #endregion Variables
        ...
        #region Constructors
        public AspNetUserDBService(ICSSPCultureService CSSPCultureService, IEnums enums,
        ...
        public async Task<ActionResult<List<AspNetUser>>> GetAspNetUserList(int skip = 0, int take = 100)
        {
            ...
            List<AspNetUser> aspNetUserList = (from c in db.AspNetUsers.AsNoTracking() orderby c.Email select c).Skip(skip).Take(take).ToList();
