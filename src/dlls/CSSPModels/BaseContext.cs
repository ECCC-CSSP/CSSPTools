...
namespace CSSPModels
{
    public partial class BaseContext : DbContext
    {
        ...
        public BaseContext(DbContextOptions<CSSPDBContext> options)
            : base(options)
        {
        }
        public BaseContext(DbContextOptions<CSSPDBLocalContext> options)
            : base(options)
        {
        }
        ...
        public BaseContext(DbContextOptions<TestDBContext> options)
            : base(options)
        {
        }
