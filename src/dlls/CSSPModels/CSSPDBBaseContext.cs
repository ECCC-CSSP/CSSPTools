...
{
    public partial class CSSPDBBaseContext : DbContext
    {
        ...
        #region Constructors
        public CSSPDBBaseContext()
        {
        }

        public CSSPDBBaseContext(DbContextOptions<CSSPDBContext> options)
            : base(options)
        {
        }
        public CSSPDBBaseContext(DbContextOptions<CSSPDBLocalContext> options)
            : base(options)
        {
        }
        public CSSPDBBaseContext(DbContextOptions<CSSPDBInMemoryContext> options)
            : base(options)
        {
        }
        public CSSPDBBaseContext(DbContextOptions<TestDBContext> options)
            : base(options)
        {
        }
