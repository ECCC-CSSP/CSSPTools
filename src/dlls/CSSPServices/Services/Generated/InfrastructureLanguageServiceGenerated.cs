...
namespace CSSPServices
{
   public partial interface IInfrastructureLanguageService
    ...
    public partial class InfrastructureLanguageService : ControllerBase, IInfrastructureLanguageService
    {
        ...
        #region Constructors
        public InfrastructureLanguageService(ICSSPCultureService CSSPCultureService, ILoggedInService LoggedInService, IEnums enums, CSSPDBContext db, CSSPDBLocalContext dbLocal, InMemoryDBContext dbIM)
        {
        ...
        public async Task<ActionResult<InfrastructureLanguage>> GetInfrastructureLanguageWithInfrastructureLanguageID(int InfrastructureLanguageID)
        {
            ...
            {
                InfrastructureLanguage infrastructureLanguage = (from c in dbIM.InfrastructureLanguages.AsNoTracking()
        ...
        public async Task<ActionResult<List<InfrastructureLanguage>>> GetInfrastructureLanguageList(int skip = 0, int take = 100)
        {
            ...
            if (LoggedInService.DBLocation == DBLocationEnum.InMemory)
            {
                List<InfrastructureLanguage> infrastructureLanguageList = (from c in dbIM.InfrastructureLanguages.AsNoTracking() orderby c.InfrastructureLanguageID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int InfrastructureLanguageID)
        {
            ...
            if (LoggedInService.DBLocation == DBLocationEnum.InMemory)
            {
                InfrastructureLanguage infrastructureLanguage = (from c in dbIM.InfrastructureLanguages
                                   where c.InfrastructureLanguageID == InfrastructureLanguageID
                                   select c).FirstOrDefault();
                ...
                try
                {
                    dbIM.InfrastructureLanguages.Remove(infrastructureLanguage);
                    dbIM.SaveChanges();
                }
        ...
        public async Task<ActionResult<InfrastructureLanguage>> Post(InfrastructureLanguage infrastructureLanguage)
        {
            ...
            if (LoggedInService.DBLocation == DBLocationEnum.InMemory)
            {
                try
                {
                    dbIM.InfrastructureLanguages.Add(infrastructureLanguage);
                    dbIM.SaveChanges();
                }
                catch (DbUpdateException ex)
                {
        ...
        public async Task<ActionResult<InfrastructureLanguage>> Put(InfrastructureLanguage infrastructureLanguage)
        {
            ...
            if (LoggedInService.DBLocation == DBLocationEnum.InMemory)
            {
                try
                {
                    dbIM.InfrastructureLanguages.Update(infrastructureLanguage);
                    dbIM.SaveChanges();
                }
                catch (DbUpdateException ex)
                {
        ...
        private IEnumerable<ValidationResult> Validate(ValidationContext validationContext, ActionDBTypeEnum actionDBType)
        {
            ...
            if (actionDBType == ActionDBTypeEnum.Update || actionDBType == ActionDBTypeEnum.Delete)
            {
                ...
                {
                    yield return new ValidationResult(string.Format(CSSPCultureServicesRes._IsRequired, "InfrastructureLanguageID"), new[] { "InfrastructureLanguageID" });
                }
                ...
                if (LoggedInService.DBLocation == DBLocationEnum.Local)
                {
                    ...
                    {
                        yield return new ValidationResult(string.Format(CSSPCultureServicesRes.CouldNotFind_With_Equal_, "InfrastructureLanguage", "InfrastructureLanguageID", infrastructureLanguage.InfrastructureLanguageID.ToString()), new[] { "InfrastructureLanguageID" });
                    }
                }
                else
                {
            ...
            if (InfrastructureInfrastructureID == null)
            {
                yield return new ValidationResult(string.Format(CSSPCultureServicesRes.CouldNotFind_With_Equal_, "Infrastructure", "InfrastructureID", infrastructureLanguage.InfrastructureID.ToString()), new[] { "InfrastructureID" });
            }
            ...
            {
                yield return new ValidationResult(string.Format(CSSPCultureServicesRes._IsRequired, "Comment"), new[] { "Comment" });
            }
            ...
            if (TVItemLastUpdateContactTVItemID == null)
            {
                yield return new ValidationResult(string.Format(CSSPCultureServicesRes.CouldNotFind_With_Equal_, "TVItem", "LastUpdateContactTVItemID", infrastructureLanguage.LastUpdateContactTVItemID.ToString()), new[] { "LastUpdateContactTVItemID" });
            }
            else
            {
