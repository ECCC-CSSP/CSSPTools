...
namespace CSSPServices
{
   public partial interface ITVItemUserAuthorizationService
    ...
    public partial class TVItemUserAuthorizationService : ControllerBase, ITVItemUserAuthorizationService
    {
        ...
        #region Constructors
        public TVItemUserAuthorizationService(ICSSPCultureService CSSPCultureService, IEnums enums, 
        ...
        public async Task<ActionResult<TVItemUserAuthorization>> GetTVItemUserAuthorizationWithTVItemUserAuthorizationID(int TVItemUserAuthorizationID)
        {
            ...
            {
                TVItemUserAuthorization tvItemUserAuthorization = (from c in dbLogin.TVItemUserAuthorizations.AsNoTracking()
                        where c.TVItemUserAuthorizationID == TVItemUserAuthorizationID
                        select c).FirstOrDefault();
        ...
        public async Task<ActionResult<List<TVItemUserAuthorization>>> GetTVItemUserAuthorizationList(int skip = 0, int take = 100)
        {
            ...
            {
                List<TVItemUserAuthorization> tvItemUserAuthorizationList = (from c in dbLogin.TVItemUserAuthorizations.AsNoTracking() orderby c.TVItemUserAuthorizationID select c).Skip(skip).Take(take).ToList();
        ...
        public async Task<ActionResult<bool>> Delete(int TVItemUserAuthorizationID)
        {
            ...
            {
                TVItemUserAuthorization tvItemUserAuthorization = (from c in dbLogin.TVItemUserAuthorizations
                                   where c.TVItemUserAuthorizationID == TVItemUserAuthorizationID
                                   select c).FirstOrDefault();
                ...
                try
                {
                   dbLogin.TVItemUserAuthorizations.Remove(tvItemUserAuthorization);
                   dbLogin.SaveChanges();
                }
                catch (DbUpdateException ex)
                {
        ...
        public async Task<ActionResult<TVItemUserAuthorization>> Post(TVItemUserAuthorization tvItemUserAuthorization)
        {
            ...
            else if (LoggedInService.DBLocation == DBLocationEnum.Login)
            {
                try
                {
                   dbLogin.TVItemUserAuthorizations.Add(tvItemUserAuthorization);
                   dbLogin.SaveChanges();
                }
                catch (DbUpdateException ex)
                {
        ...
        public async Task<ActionResult<TVItemUserAuthorization>> Put(TVItemUserAuthorization tvItemUserAuthorization)
        {
            ...
            try
            {
               dbLogin.TVItemUserAuthorizations.Update(tvItemUserAuthorization);
               dbLogin.SaveChanges();
            }
            catch (DbUpdateException ex)
            {
