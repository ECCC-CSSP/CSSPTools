...
namespace CSSPServices
{
   public interface IInfrastructureService
    ...
    public partial class InfrastructureService : ControllerBase, IInfrastructureService
    {
        ...
        #region Constructors
        public InfrastructureService(IEnums enums, CSSPDBContext db)
        {
            this.db = db;
            this.enums = enums;
        }
        ...
        public async Task<ActionResult<Infrastructure>> Add(Infrastructure infrastructure)
        {
            ...
            {
               return await Task.FromResult(BadRequest(infrastructure.ValidationResults));
            }
