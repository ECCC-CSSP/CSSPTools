...
namespace CSSPServices
{
   public interface ITVFileService
    ...
    public partial class TVFileService : ControllerBase, ITVFileService
    {
        ...
        #region Constructors
        public TVFileService(IEnums enums, CSSPDBContext db)
        {
            this.db = db;
            this.enums = enums;
        }
        ...
        public async Task<ActionResult<bool>> Delete(int TVFileID)
        {
            ...
            if (tvFile == null)
            {
                return await Task.FromResult(BadRequest(string.Format(CSSPServicesRes.CouldNotFind_With_Equal_, "TVFile", "TVFileID", TVFileID.ToString())));
            }
