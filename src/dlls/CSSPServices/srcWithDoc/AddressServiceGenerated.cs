...
namespace CSSPServices
{
    ...
    /// > <para>**Requires [CSSPModels](CSSPModels.html)** : [CSSPModels.Address](CSSPModels.Address.html)</para>
    ...
    public partial class AddressService : BaseService
    {
        ...
        #region Constructors
        /// <summary>
        /// CSSPDB Addresses table service constructor
        /// </summary>
        ...
        #region Validation
        /// <summary>
        /// Validate function for all AddressService commands
        /// </summary>
        ...
        /// <summary>
        /// Gets the Address model with the AddressID identifier
        /// </summary>
        /// <param name="AddressID">Is the identifier of [Addresses](CSSPModels.Address.html) table of CSSPDB</param>
        /// <returns>[Address](CSSPModels.Address.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [Address](CSSPModels.Address.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [Address](CSSPModels.Address.html)</returns>
        ...
        /// <summary>
        /// Adds an [Address](CSSPModels.Address.html) item in CSSPDB
        /// </summary>
        /// <param name="address">Is the Address item the client want to add to CSSPDB</param>
        /// <returns>true if Address item was added to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Deletes an [Address](CSSPModels.Address.html) item in CSSPDB
        /// </summary>
        /// <param name="address">Is the Address item the client want to add to CSSPDB. What's important here is the AddressID</param>
        /// <returns>true if Address item was deleted to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Updates an [Address](CSSPModels.Address.html) item in CSSPDB
        /// </summary>
        /// <param name="address">Is the Address item the client want to add to CSSPDB. What's important here is the AddressID</param>
        /// <returns>true if Address item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Tries to execute the CSSPDB transaction (add/delete/update) on an [Address](CSSPModels.Address.html) item
        /// </summary>
        /// <param name="address">Is the Address item the client want to add to CSSPDB. What's important here is the AddressID</param>
        /// <returns>true if Address item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
