...
namespace CSSPServices
{
    ...
    /// > <para>**Requires [CSSPModels](CSSPModels.html)** : [CSSPModels.HydrometricDataValue](CSSPModels.HydrometricDataValue.html)</para>
    ...
    public partial class HydrometricDataValueService : BaseService
    {
        ...
        #region Constructors
        /// <summary>
        /// CSSPDB HydrometricDataValues table service constructor
        /// </summary>
        ...
        #region Validation
        /// <summary>
        /// Validate function for all HydrometricDataValueService commands
        /// </summary>
        ...
        /// <summary>
        /// Gets the HydrometricDataValue model with the HydrometricDataValueID identifier
        /// </summary>
        /// <param name="HydrometricDataValueID">Is the identifier of [HydrometricDataValues](CSSPModels.HydrometricDataValue.html) table of CSSPDB</param>
        /// <returns>[HydrometricDataValue](CSSPModels.HydrometricDataValue.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [HydrometricDataValue](CSSPModels.HydrometricDataValue.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [HydrometricDataValue](CSSPModels.HydrometricDataValue.html)</returns>
        ...
        /// <summary>
        /// Adds an [HydrometricDataValue](CSSPModels.HydrometricDataValue.html) item in CSSPDB
        /// </summary>
        /// <param name="hydrometricDataValue">Is the HydrometricDataValue item the client want to add to CSSPDB</param>
        /// <returns>true if HydrometricDataValue item was added to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Deletes an [HydrometricDataValue](CSSPModels.HydrometricDataValue.html) item in CSSPDB
        /// </summary>
        /// <param name="hydrometricDataValue">Is the HydrometricDataValue item the client want to add to CSSPDB. What's important here is the HydrometricDataValueID</param>
        /// <returns>true if HydrometricDataValue item was deleted to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Updates an [HydrometricDataValue](CSSPModels.HydrometricDataValue.html) item in CSSPDB
        /// </summary>
        /// <param name="hydrometricDataValue">Is the HydrometricDataValue item the client want to add to CSSPDB. What's important here is the HydrometricDataValueID</param>
        /// <returns>true if HydrometricDataValue item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Tries to execute the CSSPDB transaction (add/delete/update) on an [HydrometricDataValue](CSSPModels.HydrometricDataValue.html) item
        /// </summary>
        /// <param name="hydrometricDataValue">Is the HydrometricDataValue item the client want to add to CSSPDB. What's important here is the HydrometricDataValueID</param>
        /// <returns>true if HydrometricDataValue item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
