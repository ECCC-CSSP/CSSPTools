...
namespace CSSPServices
{
    ...
    /// > <para>**Requires [CSSPModels](CSSPModels.html)** : [CSSPModels.MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html)</para>
    ...
    public partial class MWQMSiteStartEndDateService : BaseService
    {
        ...
        #region Constructors
        /// <summary>
        /// CSSPDB MWQMSiteStartEndDates table service constructor
        /// </summary>
        ...
        #region Validation
        /// <summary>
        /// Validate function for all MWQMSiteStartEndDateService commands
        /// </summary>
        ...
        /// <summary>
        /// Gets the MWQMSiteStartEndDate model with the MWQMSiteStartEndDateID identifier
        /// </summary>
        /// <param name="MWQMSiteStartEndDateID">Is the identifier of [MWQMSiteStartEndDates](CSSPModels.MWQMSiteStartEndDate.html) table of CSSPDB</param>
        /// <returns>[MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html)</returns>
        ...
        /// <summary>
        /// Adds an [MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html) item in CSSPDB
        /// </summary>
        /// <param name="mwqmSiteStartEndDate">Is the MWQMSiteStartEndDate item the client want to add to CSSPDB</param>
        /// <returns>true if MWQMSiteStartEndDate item was added to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Deletes an [MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html) item in CSSPDB
        /// </summary>
        /// <param name="mwqmSiteStartEndDate">Is the MWQMSiteStartEndDate item the client want to add to CSSPDB. What's important here is the MWQMSiteStartEndDateID</param>
        /// <returns>true if MWQMSiteStartEndDate item was deleted to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Updates an [MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html) item in CSSPDB
        /// </summary>
        /// <param name="mwqmSiteStartEndDate">Is the MWQMSiteStartEndDate item the client want to add to CSSPDB. What's important here is the MWQMSiteStartEndDateID</param>
        /// <returns>true if MWQMSiteStartEndDate item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Tries to execute the CSSPDB transaction (add/delete/update) on an [MWQMSiteStartEndDate](CSSPModels.MWQMSiteStartEndDate.html) item
        /// </summary>
        /// <param name="mwqmSiteStartEndDate">Is the MWQMSiteStartEndDate item the client want to add to CSSPDB. What's important here is the MWQMSiteStartEndDateID</param>
        /// <returns>true if MWQMSiteStartEndDate item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
