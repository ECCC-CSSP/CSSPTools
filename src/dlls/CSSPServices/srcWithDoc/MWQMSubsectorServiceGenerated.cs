...
namespace CSSPServices
{
    ...
    /// > <para>**Requires [CSSPModels](CSSPModels.html)** : [CSSPModels.MWQMSubsector](CSSPModels.MWQMSubsector.html)</para>
    ...
    public partial class MWQMSubsectorService : BaseService
    {
        ...
        #region Constructors
        /// <summary>
        /// CSSPDB MWQMSubsectors table service constructor
        /// </summary>
        ...
        #region Validation
        /// <summary>
        /// Validate function for all MWQMSubsectorService commands
        /// </summary>
        ...
        /// <summary>
        /// Gets the MWQMSubsector model with the MWQMSubsectorID identifier
        /// </summary>
        /// <param name="MWQMSubsectorID">Is the identifier of [MWQMSubsectors](CSSPModels.MWQMSubsector.html) table of CSSPDB</param>
        /// <returns>[MWQMSubsector](CSSPModels.MWQMSubsector.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [MWQMSubsector](CSSPModels.MWQMSubsector.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [MWQMSubsector](CSSPModels.MWQMSubsector.html)</returns>
        ...
        /// <summary>
        /// Adds an [MWQMSubsector](CSSPModels.MWQMSubsector.html) item in CSSPDB
        /// </summary>
        /// <param name="mwqmSubsector">Is the MWQMSubsector item the client want to add to CSSPDB</param>
        /// <returns>true if MWQMSubsector item was added to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Deletes an [MWQMSubsector](CSSPModels.MWQMSubsector.html) item in CSSPDB
        /// </summary>
        /// <param name="mwqmSubsector">Is the MWQMSubsector item the client want to add to CSSPDB. What's important here is the MWQMSubsectorID</param>
        /// <returns>true if MWQMSubsector item was deleted to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Updates an [MWQMSubsector](CSSPModels.MWQMSubsector.html) item in CSSPDB
        /// </summary>
        /// <param name="mwqmSubsector">Is the MWQMSubsector item the client want to add to CSSPDB. What's important here is the MWQMSubsectorID</param>
        /// <returns>true if MWQMSubsector item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Tries to execute the CSSPDB transaction (add/delete/update) on an [MWQMSubsector](CSSPModels.MWQMSubsector.html) item
        /// </summary>
        /// <param name="mwqmSubsector">Is the MWQMSubsector item the client want to add to CSSPDB. What's important here is the MWQMSubsectorID</param>
        /// <returns>true if MWQMSubsector item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
