...
namespace CSSPServices
{
    ...
    /// > <para>**Requires [CSSPModels](CSSPModels.html)** : [CSSPModels.TVFileLanguage](CSSPModels.TVFileLanguage.html)</para>
    ...
    public partial class TVFileLanguageService : BaseService
    {
        ...
        #region Constructors
        /// <summary>
        /// CSSPDB TVFileLanguages table service constructor
        /// </summary>
        ...
        #region Validation
        /// <summary>
        /// Validate function for all TVFileLanguageService commands
        /// </summary>
        ...
        /// <summary>
        /// Gets the TVFileLanguage model with the TVFileLanguageID identifier
        /// </summary>
        /// <param name="TVFileLanguageID">Is the identifier of [TVFileLanguages](CSSPModels.TVFileLanguage.html) table of CSSPDB</param>
        /// <returns>[TVFileLanguage](CSSPModels.TVFileLanguage.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [TVFileLanguage](CSSPModels.TVFileLanguage.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [TVFileLanguage](CSSPModels.TVFileLanguage.html)</returns>
        ...
        /// <summary>
        /// Adds an [TVFileLanguage](CSSPModels.TVFileLanguage.html) item in CSSPDB
        /// </summary>
        /// <param name="tvFileLanguage">Is the TVFileLanguage item the client want to add to CSSPDB</param>
        /// <returns>true if TVFileLanguage item was added to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Deletes an [TVFileLanguage](CSSPModels.TVFileLanguage.html) item in CSSPDB
        /// </summary>
        /// <param name="tvFileLanguage">Is the TVFileLanguage item the client want to add to CSSPDB. What's important here is the TVFileLanguageID</param>
        /// <returns>true if TVFileLanguage item was deleted to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Updates an [TVFileLanguage](CSSPModels.TVFileLanguage.html) item in CSSPDB
        /// </summary>
        /// <param name="tvFileLanguage">Is the TVFileLanguage item the client want to add to CSSPDB. What's important here is the TVFileLanguageID</param>
        /// <returns>true if TVFileLanguage item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Tries to execute the CSSPDB transaction (add/delete/update) on an [TVFileLanguage](CSSPModels.TVFileLanguage.html) item
        /// </summary>
        /// <param name="tvFileLanguage">Is the TVFileLanguage item the client want to add to CSSPDB. What's important here is the TVFileLanguageID</param>
        /// <returns>true if TVFileLanguage item was updated to CSSPDB, false if an error happened during the DB requested transtaction</returns>
