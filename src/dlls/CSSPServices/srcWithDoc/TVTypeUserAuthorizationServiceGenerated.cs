...
namespace CSSPServices
{
    ...
    /// > <para>**Requires [CSSPModels](CSSPModels.html)** : [CSSPModels.TVTypeUserAuthorization](CSSPModels.TVTypeUserAuthorization.html)</para>
    ...
    public partial class TVTypeUserAuthorizationService : BaseService
    {
        ...
        #region Constructors
        /// <summary>
        /// CSSPDB TVTypeUserAuthorizations table service constructor
        /// </summary>
        ...
        /// <summary>
        /// Gets the TVTypeUserAuthorization model with the TVTypeUserAuthorizationID identifier
        /// </summary>
        /// <param name="TVTypeUserAuthorizationID">Is the identifier of [TVTypeUserAuthorizations](CSSPModels.TVTypeUserAuthorization.html) table of CSSPDB</param>
        /// <returns>[TVTypeUserAuthorization](CSSPModels.TVTypeUserAuthorization.html) object connected to the CSSPDB</returns>
        ...
        /// <summary>
        /// Gets a list of [TVTypeUserAuthorization](CSSPModels.TVTypeUserAuthorization.html) satisfying the filters in [Query](CSSPModels.Query.html)
        /// </summary>
        /// <returns>IQueryable of [TVTypeUserAuthorization](CSSPModels.TVTypeUserAuthorization.html)</returns>
        ...
        /// <summary>
        /// Adds an [TVTypeUserAuthorization](CSSPModels.TVTypeUserAuthorization.html) item in CSSPDB
        /// </summary>
        /// <param name="tvTypeUserAuthorization">Is the TVTypeUserAuthorization item the client want to add to CSSPDB</param>
        /// <returns>true if TVTypeUserAuthorization item was added to CSSPDB, false if an error happened during the DB requested transtaction</returns>
        ...
        /// <summary>
        /// Deletes an [TVTypeUserAuthorization](CSSPModels.TVTypeUserAuthorization.html) item in CSSPDB
        /// </summary>
        ...
        /// <returns>true if TVTypeUserAuthorization item was deleted to CSSPDB, false if an error happened during the DB requested transtaction</returns>
