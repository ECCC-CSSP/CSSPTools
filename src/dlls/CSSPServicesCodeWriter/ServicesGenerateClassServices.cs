...
namespace CSSPServicesGenerateCodeHelper
{
    public partial class ServicesCodeWriter
    {
        ...
        /// <summary>
        /// Generates:
        ///     C:\CSSPTools\src\dlls\CSSPServices\srcWithDoc\[ServiceClassName]ServiceGenerated.cs file
        /// 
        /// Requires:
        ...
        public void ClassNameServiceGenerated(bool WithDoc)
        {
            ...
            foreach (DLLTypeInfo dllTypeInfoModels in DLLTypeInfoCSSPModelsList)
            {
                ...
                if (WithDoc) //------------------------------------------------------------------ help
                {
                    sb.AppendLine(@" * Auto generated from the CSSPCodeWriter.proj by clicking on the [\srcWithDoc\[ClassName]ServiceGenerated.cs] button");
                }
                else
                {
                ...
                if (WithDoc)
                {
                    fiOutputGen = new FileInfo($@"C:\CSSPTools\src\dlls\CSSPServices\srcWithDoc\{ dllTypeInfoModels.Type.Name }ServiceGenerated.cs");
                }
                else
                {
                    fiOutputGen = new FileInfo($@"C:\CSSPTools\src\dlls\CSSPServices\src\{ dllTypeInfoModels.Type.Name }ServiceGenerated.cs");
                }
