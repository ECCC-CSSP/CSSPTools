...
{
    private async Task<bool> MergeJsonWebAllPolSourceSiteEffectTerms(WebAllPolSourceSiteEffectTerms webAllPolSourceSiteEffectTerms, WebAllPolSourceSiteEffectTerms webAllPolSourceSiteEffectTermsLocal)
    {
