...
public partial class AppTaskLocalServiceTest : CSSPDBLocalServiceTest
{
    ...
    public async Task ModifyAppTaskLocal_Good_Test(string culture)
    {
        ...
        appTaskModelRet1.AppTask.Parameters = "Some parameters";
        appTaskModelRet1.AppTaskLanguageList[0].StatusText = "Some StatusText";
        appTaskModelRet1.AppTaskLanguageList[0].ErrorText = "Some ErrorText";
        appTaskModelRet1.AppTaskLanguageList[1].StatusText = "un text Status";
        appTaskModelRet1.AppTaskLanguageList[1].ErrorText = "un text Error";
        ...
        Assert.Equal(appTaskModelRet1.AppTask.TVItemID, appTaskModelRet.AppTask.TVItemID);
        Assert.Equal(appTaskModelRet1.AppTask.TVItemID2, appTaskModelRet.AppTask.TVItemID2);
        Assert.Equal(appTaskModelRet1.AppTask.AppTaskCommand, appTaskModelRet.AppTask.AppTaskCommand);
        Assert.Equal(appTaskModelRet1.AppTask.AppTaskStatus, appTaskModelRet.AppTask.AppTaskStatus);
        Assert.Equal(appTaskModelRet1.AppTask.PercentCompleted, appTaskModelRet.AppTask.PercentCompleted);
        Assert.Equal(appTaskModelRet1.AppTask.Parameters, appTaskModelRet.AppTask.Parameters);
        Assert.Equal(appTaskModelRet1.AppTask.Language, appTaskModelRet.AppTask.Language);
        Assert.Equal(appTaskModelRet1.AppTask.StartDateTime_UTC, appTaskModelRet.AppTask.StartDateTime_UTC);
        Assert.Equal(appTaskModelRet1.AppTask.EndDateTime_UTC, appTaskModelRet.AppTask.EndDateTime_UTC);
        Assert.Equal(appTaskModelRet1.AppTask.EstimatedLength_second, appTaskModelRet.AppTask.EstimatedLength_second);
        Assert.Equal(appTaskModelRet1.AppTask.RemainingTime_second, appTaskModelRet.AppTask.RemainingTime_second);
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_Unauthorized_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_Unauthorized2_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_TVItemID_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_TVItemID2_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_PercentCompeted_0_to_100_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_Parameters_length_100000_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task ModifyAppTaskLocal_AppTaskLanguage_CountNot2_Error_Test(string culture)
    {
        Assert.True(await AppTaskLocalServiceSetupAsync(culture));
    ...
    public async Task ModifyAppTaskLocal_AppTaskLanguage_EN_AppTaskLanguageID_Error_Test(string culture)
    {
        ...
        Assert.NotNull(((BadRequestObjectResult)actionRes.Result).Value);
        ErrRes errRes = (ErrRes)((BadRequestObjectResult)actionRes.Result).Value;
        Assert.Contains(string.Format(CSSPCultureServicesRes._IsRequired, "AppTaskLanguageID"), errRes.ErrList);
    }
    [Theory]
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    ...
    public async Task ModifyAppTaskLocal_CouldNotFind_Error_Test(string culture)
    {
        ...
        var actionRes = await AppTaskLocalService.ModifyAppTaskLocalAsync(appTaskModelRet);
        Assert.Equal(400, ((ObjectResult)actionRes.Result).StatusCode);
        Assert.NotNull(((BadRequestObjectResult)actionRes.Result).Value);
        ErrRes errRes = (ErrRes)((BadRequestObjectResult)actionRes.Result).Value;
        Assert.Contains(string.Format(CSSPCultureServicesRes.CouldNotFind_With_Equal_, "AppTask", "AppTaskID", appTaskLocalModel.AppTask.AppTaskID), errRes.ErrList);
    }
}
