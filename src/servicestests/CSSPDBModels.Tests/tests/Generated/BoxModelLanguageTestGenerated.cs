...
public partial class BoxModelLanguageTest
{
    ...
    {
        List<string> propNameList = new List<string>() { "BoxModelLanguageID", "DBCommand", "BoxModelID", "Language", "ScenarioName", "TranslationStatus", "LastUpdateDate_UTC", "LastUpdateContactTVItemID",  }.OrderBy(c => c).ToList();
    ...
    public void BoxModelLanguage_Every_Property_Has_Get_Set_Test()
    {
           ...
           boxModelLanguage.DBCommand = val2;
           Assert.Equal(val2, boxModelLanguage.DBCommand);
           int val3 = 45;
           boxModelLanguage.BoxModelID = val3;
           Assert.Equal(val3, boxModelLanguage.BoxModelID);
           LanguageEnum val4 = (LanguageEnum)3;
           boxModelLanguage.Language = val4;
           Assert.Equal(val4, boxModelLanguage.Language);
           string val5 = "Some text";
           boxModelLanguage.ScenarioName = val5;
           Assert.Equal(val5, boxModelLanguage.ScenarioName);
           TranslationStatusEnum val6 = (TranslationStatusEnum)3;
           boxModelLanguage.TranslationStatus = val6;
           Assert.Equal(val6, boxModelLanguage.TranslationStatus);
           DateTime val7 = new DateTime(2010, 3, 4);
           boxModelLanguage.LastUpdateDate_UTC = val7;
           Assert.Equal(val7, boxModelLanguage.LastUpdateDate_UTC);
           int val8 = 45;
           boxModelLanguage.LastUpdateContactTVItemID = val8;
           Assert.Equal(val8, boxModelLanguage.LastUpdateContactTVItemID);
    }
}
