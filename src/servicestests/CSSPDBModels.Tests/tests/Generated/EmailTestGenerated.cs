...
public partial class EmailTest
{
    ...
    {
        List<string> propNameList = new List<string>() { "EmailID", "DBCommand", "EmailTVItemID", "EmailAddress", "EmailType", "LastUpdateDate_UTC", "LastUpdateContactTVItemID",  }.OrderBy(c => c).ToList();
    ...
    public void Email_Every_Property_Has_Get_Set_Test()
    {
           ...
           email.DBCommand = val2;
           Assert.Equal(val2, email.DBCommand);
           int val3 = 45;
           email.EmailTVItemID = val3;
           Assert.Equal(val3, email.EmailTVItemID);
           string val4 = "Some text";
           email.EmailAddress = val4;
           Assert.Equal(val4, email.EmailAddress);
           EmailTypeEnum val5 = (EmailTypeEnum)3;
           email.EmailType = val5;
           Assert.Equal(val5, email.EmailType);
           DateTime val6 = new DateTime(2010, 3, 4);
           email.LastUpdateDate_UTC = val6;
           Assert.Equal(val6, email.LastUpdateDate_UTC);
           int val7 = 45;
           email.LastUpdateContactTVItemID = val7;
           Assert.Equal(val7, email.LastUpdateContactTVItemID);
    }
}
