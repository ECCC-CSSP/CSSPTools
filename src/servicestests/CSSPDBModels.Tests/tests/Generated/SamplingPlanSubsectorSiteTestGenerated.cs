...
public partial class SamplingPlanSubsectorSiteTest
{
    ...
    {
        List<string> propNameList = new List<string>() { "SamplingPlanSubsectorSiteID", "DBCommand", "SamplingPlanSubsectorID", "MWQMSiteTVItemID", "IsDuplicate", "LastUpdateDate_UTC", "LastUpdateContactTVItemID",  }.OrderBy(c => c).ToList();
    ...
    public void SamplingPlanSubsectorSite_Every_Property_Has_Get_Set_Test()
    {
           ...
           samplingPlanSubsectorSite.DBCommand = val2;
           Assert.Equal(val2, samplingPlanSubsectorSite.DBCommand);
           int val3 = 45;
           samplingPlanSubsectorSite.SamplingPlanSubsectorID = val3;
           Assert.Equal(val3, samplingPlanSubsectorSite.SamplingPlanSubsectorID);
           int val4 = 45;
           samplingPlanSubsectorSite.MWQMSiteTVItemID = val4;
           Assert.Equal(val4, samplingPlanSubsectorSite.MWQMSiteTVItemID);
           bool val5 = true;
           samplingPlanSubsectorSite.IsDuplicate = val5;
           Assert.Equal(val5, samplingPlanSubsectorSite.IsDuplicate);
           DateTime val6 = new DateTime(2010, 3, 4);
           samplingPlanSubsectorSite.LastUpdateDate_UTC = val6;
           Assert.Equal(val6, samplingPlanSubsectorSite.LastUpdateDate_UTC);
           int val7 = 45;
           samplingPlanSubsectorSite.LastUpdateContactTVItemID = val7;
           Assert.Equal(val7, samplingPlanSubsectorSite.LastUpdateContactTVItemID);
    }
}
