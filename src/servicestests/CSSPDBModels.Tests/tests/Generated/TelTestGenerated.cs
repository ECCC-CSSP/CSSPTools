...
public partial class TelTest
{
    ...
    {
        List<string> propNameList = new List<string>() { "TelID", "DBCommand", "TelTVItemID", "TelNumber", "TelType", "LastUpdateDate_UTC", "LastUpdateContactTVItemID",  }.OrderBy(c => c).ToList();
    ...
    public void Tel_Every_Property_Has_Get_Set_Test()
    {
           ...
           tel.DBCommand = val2;
           Assert.Equal(val2, tel.DBCommand);
           int val3 = 45;
           tel.TelTVItemID = val3;
           Assert.Equal(val3, tel.TelTVItemID);
           string val4 = "Some text";
           tel.TelNumber = val4;
           Assert.Equal(val4, tel.TelNumber);
           TelTypeEnum val5 = (TelTypeEnum)3;
           tel.TelType = val5;
           Assert.Equal(val5, tel.TelType);
           DateTime val6 = new DateTime(2010, 3, 4);
           tel.LastUpdateDate_UTC = val6;
           Assert.Equal(val6, tel.LastUpdateDate_UTC);
           int val7 = 45;
           tel.LastUpdateContactTVItemID = val7;
           Assert.Equal(val7, tel.LastUpdateContactTVItemID);
    }
}
