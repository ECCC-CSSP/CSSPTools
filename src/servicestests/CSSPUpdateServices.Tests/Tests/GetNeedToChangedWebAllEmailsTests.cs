...
public partial class UpdateServiceTests
{
    ...
    public async Task GetNeedToChangedWebAllEmails_HasEmail_Good_Test(string culture)
    {
        ...
        Assert.True(await CSSPUpdateService.GetNeedToChangedWebAllEmailsAsync(LastUpdateDate_UTC));
    }
    [Theory]
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task GetNeedToChangedWebAllEmails_NoEmail_Good_Test(string culture)
    {
        ...
        Assert.False(await CSSPUpdateService.GetNeedToChangedWebAllEmailsAsync(LastUpdateDate_UTC));
    }
