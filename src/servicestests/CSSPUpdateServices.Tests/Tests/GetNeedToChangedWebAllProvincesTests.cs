...
public partial class UpdateServiceTests
{
    ...
    public async Task GetNeedToChangedWebAllProvinces_HasProvince_Good_Test(string culture)
    {
        ...
        Assert.True(await CSSPUpdateService.GetNeedToChangedWebAllProvincesAsync(LastUpdateDate_UTC));
    }
    [Theory]
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task GetNeedToChangedWebAllProvinces_NoProvince_Good_Test(string culture)
    {
        ...
        Assert.False(await CSSPUpdateService.GetNeedToChangedWebAllProvincesAsync(LastUpdateDate_UTC));
    }
