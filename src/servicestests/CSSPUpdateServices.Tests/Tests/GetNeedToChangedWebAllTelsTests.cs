...
public partial class UpdateServiceTests
{
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task GetNeedToChangedWebAllTels_HasTel_Good_Test(string culture)
    {
    ...
    [InlineData("en-CA")]
    //[InlineData("fr-CA")]
    public async Task GetNeedToChangedWebAllTels_NoTel_Good_Test(string culture)
    {
        Assert.True(await CSSPUpdateServiceSetup(culture));
