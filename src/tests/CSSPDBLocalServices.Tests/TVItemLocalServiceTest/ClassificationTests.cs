...
namespace CSSPDBLocalServices.Tests
{
    public partial class TVItemLocalServiceTest
    {
        ...
        public async Task Classification_AddTVItemLocal_Good_Test(string culture)
        {
            ...
            TVItemModel tvItemModel = webSubsector.TVItemModelClassificationList.Where(c => c.TVItem.TVItemID == -1
            && c.TVItem.TVType == TVTypeEnum.Classification).FirstOrDefault();
        ...
        public async Task Classification_DeleteTVItemLocal_Good_Test(string culture)
        {
            foreach (int skip in new List<int>() { 0, 2 })
            {
                ...
                Assert.True(webSubsector.TVItemModelClassificationList.Count > 3);

                TVItemModel tvItemModelClassification = (from c in webSubsector.TVItemModelClassificationList
                                                         select c).Skip(skip).Take(1).First();

                TVItemLocalModel postTVItemModel = new TVItemLocalModel()
                {
                    TVItem = tvItemModelClassification.TVItem,
                    TVItemLanguageList = tvItemModelClassification.TVItemLanguageList,
                ...
                Assert.True(webSubsector.TVItemModelClassificationList.Where(c => c.TVItem.TVItemID == postTVItemModel.TVItem.TVItemID
                && c.TVItem.TVType == TVTypeEnum.Classification).Any());

                TVItemModel tvItemModel = webSubsector.TVItemModelClassificationList.Where(c => c.TVItem.TVItemID == postTVItemModel.TVItem.TVItemID
                && c.TVItem.TVType == TVTypeEnum.Classification).FirstOrDefault();
                Assert.NotNull(tvItemModel);
