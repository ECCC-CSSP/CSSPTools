...
namespace CSSPDBLocalServices.Tests
{
    public partial class TVItemLocalServiceTest
    {
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task File_Root_AddTVItemLocal_Good_Test(string culture)
        {
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task File_Root_DeleteTVItemLocal_Good_Test(string culture)
        {
            Assert.True(await TVItemLocalServiceSetup(culture));
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task File_Root_ModifyTVItemLocal_Good_Test(string culture)
        {
            Assert.True(await TVItemLocalServiceSetup(culture));
