...
namespace CSSPDBLocalServices.Tests
{
    public partial class TVItemLocalServiceTest
    {
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task Properties_TVItemParent_DBCommand_Error_Test(string culture)
        {
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task Properties_TVItemParent_TVType_Error_Test(string culture)
        {
            Assert.True(await TVItemLocalServiceSetup(culture));
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task Properties_TVItemParent_TVLevel_Error_Test(string culture)
        {
            Assert.True(await TVItemLocalServiceSetup(culture));
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task Properties_TVItemParent_TVPath_Error_Test(string culture)
        {
            Assert.True(await TVItemLocalServiceSetup(culture));
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task Properties_TVItemParent_ParentID_Error_Test(string culture)
        {
            Assert.True(await TVItemLocalServiceSetup(culture));
