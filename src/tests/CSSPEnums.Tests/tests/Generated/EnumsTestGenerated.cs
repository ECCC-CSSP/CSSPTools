...
namespace CSSPEnums.Tests
{
    public partial class EnumsTest
    {
            ...
            foreach (int i in Enum.GetValues(typeof(DBLocationEnum)))
            {
                ...
                switch ((DBLocationEnum)i)
                {
                    case DBLocationEnum.Local:
                        Assert.Equal(CultureEnumsRes.DBLocationEnumLocal, retStr);
                        break;
                    case DBLocationEnum.Server:
                        Assert.Equal(CultureEnumsRes.DBLocationEnumServer, retStr);
                        break;
                    case DBLocationEnum.InMemory:
                        Assert.Equal(CultureEnumsRes.DBLocationEnumInMemory, retStr);
                        break;
                    default:
                        Assert.Equal(CultureEnumsRes.Empty, retStr);
                        break;
        ...
        public async Task Enums_DBLocationOK_Test(string culture)
        {
            ...
            Assert.Equal(string.Format(CultureEnumsRes._IsRequired, "DBLocationEnum"), retStr);
