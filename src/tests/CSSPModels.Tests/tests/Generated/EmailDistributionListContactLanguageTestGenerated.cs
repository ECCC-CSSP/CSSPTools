...
namespace CSSPModels.Tests
{
    public partial class EmailDistributionListContactLanguageTest
    {
        ...
        {
             Assert.True(typeof(EmailDistributionListContactLanguage).GetProperties().Where(c => c.Name == "ValidationResults").Any());
        }
        [Fact]
        public void EmailDistributionListContactLanguage_Every_Property_Has_Get_Set_Test()
        {
               ...
               Assert.Equal(val8, emailDistributionListContactLanguage.HasErrors);
               ...
               Assert.Equal(val27, emailDistributionListContactLanguage.ValidationResults);
        }
