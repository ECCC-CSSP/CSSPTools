...
namespace CSSPModels.Tests
{
    public partial class EmailDistributionListTest
    {
        ...
        {
             Assert.True(typeof(EmailDistributionList).GetProperties().Where(c => c.Name == "ValidationResults").Any());
        }
        [Fact]
        public void EmailDistributionList_Every_Property_Has_Get_Set_Test()
        {
               ...
               Assert.Equal(val6, emailDistributionList.HasErrors);
               ...
               Assert.Equal(val21, emailDistributionList.ValidationResults);
        }
