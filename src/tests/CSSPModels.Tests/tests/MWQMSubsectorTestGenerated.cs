...
namespace CSSPModels.Tests
{
    ...
    public partial class MWQMSubsectorTest
    {
        ...
        {
             Assert.True(typeof(MWQMSubsector).GetProperties().Where(c => c.Name == "ValidationResults").Any());
        }
        [Fact]
        public void MWQMSubsector_Every_Property_Has_Get_Set_Test()
        {
               ...
               Assert.Equal(val2, mWQMSubsector.MWQMSubsectorTVItemID);
               string val3 = "Some text";
               mWQMSubsector.SubsectorHistoricKey = val3;
               Assert.Equal(val3, mWQMSubsector.SubsectorHistoricKey);
               string val4 = "Some text";
               mWQMSubsector.TideLocationSIDText = val4;
               Assert.Equal(val4, mWQMSubsector.TideLocationSIDText);
               DateTime val5 = new DateTime(2010, 3, 4);
               mWQMSubsector.LastUpdateDate_UTC = val5;
               Assert.Equal(val5, mWQMSubsector.LastUpdateDate_UTC);
               int val6 = 45;
               mWQMSubsector.LastUpdateContactTVItemID = val6;
               Assert.Equal(val6, mWQMSubsector.LastUpdateContactTVItemID);
               bool val7 = true;
               mWQMSubsector.HasErrors = val7;
               Assert.Equal(val7, mWQMSubsector.HasErrors);
               ...
               Assert.Equal(val24, mWQMSubsector.ValidationResults);
        }
