        ...
        public void GetDrogueRunWithDrogueRunID__drogueRun_DrogueRunID__Test()
        {
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    ...
                    {
                        drogueRunService.Query.Extra = extra;

                        if (string.IsNullOrWhiteSpace(extra))
                        {
                            DrogueRun drogueRunRet = drogueRunService.GetDrogueRunWithDrogueRunID(drogueRun.DrogueRunID);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        drogueRunService.Query = drogueRunService.FillQuery(typeof(DrogueRun), culture.TwoLetterISOLanguageName, 1, 1, "", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        drogueRunService.Query = drogueRunService.FillQuery(typeof(DrogueRun), culture.TwoLetterISOLanguageName, 1, 1,  "DrogueRunID", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        drogueRunService.Query = drogueRunService.FillQuery(typeof(DrogueRun), culture.TwoLetterISOLanguageName, 1, 1, "DrogueRunID,SubsectorTVItemID", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        drogueRunService.Query = drogueRunService.FillQuery(typeof(DrogueRun), culture.TwoLetterISOLanguageName, 0, 10000, "", "", "DrogueRunID,GT,2|DrogueRunID,LT,5", extra);
