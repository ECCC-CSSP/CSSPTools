        ...
        public void GetPolSourceSiteEffectWithPolSourceSiteEffectID__polSourceSiteEffect_PolSourceSiteEffectID__Test()
        {
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    ...
                    {
                        polSourceSiteEffectService.Query.Extra = extra;

                        if (string.IsNullOrWhiteSpace(extra))
                        {
                            PolSourceSiteEffect polSourceSiteEffectRet = polSourceSiteEffectService.GetPolSourceSiteEffectWithPolSourceSiteEffectID(polSourceSiteEffect.PolSourceSiteEffectID);
                            CheckPolSourceSiteEffectFields(new List<PolSourceSiteEffect>() { polSourceSiteEffectRet });
                            Assert.AreEqual(polSourceSiteEffect.PolSourceSiteEffectID, polSourceSiteEffectRet.PolSourceSiteEffectID);
                        }
                        else
                        {
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        polSourceSiteEffectService.Query = polSourceSiteEffectService.FillQuery(typeof(PolSourceSiteEffect), culture.TwoLetterISOLanguageName, 1, 1, "", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        polSourceSiteEffectService.Query = polSourceSiteEffectService.FillQuery(typeof(PolSourceSiteEffect), culture.TwoLetterISOLanguageName, 1, 1,  "PolSourceSiteEffectID", "", "", extra);
