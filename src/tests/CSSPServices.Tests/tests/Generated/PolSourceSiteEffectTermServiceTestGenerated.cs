            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    ...
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        {
                            PolSourceSiteEffectTerm polSourceSiteEffectTermRet = polSourceSiteEffectTermService.GetPolSourceSiteEffectTermWithPolSourceSiteEffectTermID(polSourceSiteEffectTerm.PolSourceSiteEffectTermID);
                            CheckPolSourceSiteEffectTermFields(new List<PolSourceSiteEffectTerm>() { polSourceSiteEffectTermRet });
                            Assert.AreEqual(polSourceSiteEffectTerm.PolSourceSiteEffectTermID, polSourceSiteEffectTermRet.PolSourceSiteEffectTermID);
                        }
                        else
                        {
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        polSourceSiteEffectTermService.Query = polSourceSiteEffectTermService.FillQuery(typeof(PolSourceSiteEffectTerm), culture.TwoLetterISOLanguageName, 1, 1, "", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        polSourceSiteEffectTermService.Query = polSourceSiteEffectTermService.FillQuery(typeof(PolSourceSiteEffectTerm), culture.TwoLetterISOLanguageName, 1, 1,  "PolSourceSiteEffectTermID", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        polSourceSiteEffectTermService.Query = polSourceSiteEffectTermService.FillQuery(typeof(PolSourceSiteEffectTerm), culture.TwoLetterISOLanguageName, 1, 1, "PolSourceSiteEffectTermID,IsGroup", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        polSourceSiteEffectTermService.Query = polSourceSiteEffectTermService.FillQuery(typeof(PolSourceSiteEffectTerm), culture.TwoLetterISOLanguageName, 0, 10000, "", "", "PolSourceSiteEffectTermID,GT,2|PolSourceSiteEffectTermID,LT,5", extra);
