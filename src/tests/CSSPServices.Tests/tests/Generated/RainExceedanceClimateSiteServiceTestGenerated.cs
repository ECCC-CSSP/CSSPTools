            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    ...
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        {
                            RainExceedanceClimateSite rainExceedanceClimateSiteRet = rainExceedanceClimateSiteService.GetRainExceedanceClimateSiteWithRainExceedanceClimateSiteID(rainExceedanceClimateSite.RainExceedanceClimateSiteID);
                            CheckRainExceedanceClimateSiteFields(new List<RainExceedanceClimateSite>() { rainExceedanceClimateSiteRet });
                            Assert.AreEqual(rainExceedanceClimateSite.RainExceedanceClimateSiteID, rainExceedanceClimateSiteRet.RainExceedanceClimateSiteID);
                        }
                        else
                        {
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        rainExceedanceClimateSiteService.Query = rainExceedanceClimateSiteService.FillQuery(typeof(RainExceedanceClimateSite), culture.TwoLetterISOLanguageName, 1, 1, "", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        rainExceedanceClimateSiteService.Query = rainExceedanceClimateSiteService.FillQuery(typeof(RainExceedanceClimateSite), culture.TwoLetterISOLanguageName, 1, 1,  "RainExceedanceClimateSiteID", "", "", extra);
            ...
            foreach (CultureInfo culture in AllowableCulture)
            {
                ...
                using (CSSPDBContext dbTestDB = new CSSPDBContext(DatabaseTypeEnum.SqlServerTestDB))
                {
                    foreach (string extra in new List<string>() { null, "A", "B", "C", "D", "E" })
                    {
                        ...
                        rainExceedanceClimateSiteService.Query = rainExceedanceClimateSiteService.FillQuery(typeof(RainExceedanceClimateSite), culture.TwoLetterISOLanguageName, 1, 1, "RainExceedanceClimateSiteID,RainExceedanceTVItemID", "", "", extra);
