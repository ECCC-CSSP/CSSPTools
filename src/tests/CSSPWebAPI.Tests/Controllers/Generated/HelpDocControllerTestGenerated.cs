        ...
        public void HelpDoc_Controller_GetHelpDocList_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    Assert.Equal(helpDocFirst.HelpDocID, ((List<HelpDoc>)ret.Value)[0].HelpDocID);
                    Assert.Equal((count > query.Take ? query.Take : count), ((List<HelpDoc>)ret.Value).Count);
                    ...
                    if (count > 0)
                    {
                        ...
                        Assert.Equal(helpDocList[0].HelpDocID, ((List<HelpDoc>)ret.Value)[0].HelpDocID);
                        Assert.Equal((count > query.Take ? query.Take : count), ((List<HelpDoc>)ret.Value).Count);
                       ...
                       if (count > 1)
                       {
                           ...
                           Assert.Equal(helpDocList[1].HelpDocID, ((List<HelpDoc>)ret2.Value)[0].HelpDocID);
                           Assert.Equal((count > query.Take ? query.Take : count), ((List<HelpDoc>)ret2.Value).Count);
                       }
                    }
                }
            }
        ...
        public void HelpDoc_Controller_GetHelpDocWithID_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    Assert.Equal(helpDocFirst.HelpDocID, ((HelpDoc)ret.Value).HelpDocID);
                    ...
                    OkObjectResult helpDocRet2 = jsonRet2 as OkObjectResult;
        ...
        public void HelpDoc_Controller_Put_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    OkObjectResult helpDocRet3 = jsonRet3 as OkObjectResult;
        ...
        public void HelpDoc_Controller_Delete_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    HelpDoc helpDoc = (HelpDoc)ret3.Value;
