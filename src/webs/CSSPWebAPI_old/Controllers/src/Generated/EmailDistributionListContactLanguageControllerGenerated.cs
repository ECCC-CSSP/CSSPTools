        ...
        public IActionResult Post(EmailDistributionListContactLanguage emailDistributionListContactLanguage, string lang = "en")
        {
            using (CSSPDBContext db = new CSSPDBContext(DatabaseType))
            {
                ...
                else
                {
                    ...
                    return Created("/api/emailDistributionListContactLanguage/" + emailDistributionListContactLanguage.EmailDistributionListContactLanguageID, emailDistributionListContactLanguage);
                }
            }
        }
