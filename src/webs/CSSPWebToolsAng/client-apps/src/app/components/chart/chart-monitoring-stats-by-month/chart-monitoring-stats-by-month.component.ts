...
@Component({
  selector: 'app-chart-monitoring-stats-by-month',
  templateUrl: './chart-monitoring-stats-by-month.component.html',
  styleUrls: ['./chart-monitoring-stats-by-month.component.css'],
})
export class ChartMonitoringStatsByMonthComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('chart')
  chartRef: ElementRef;
