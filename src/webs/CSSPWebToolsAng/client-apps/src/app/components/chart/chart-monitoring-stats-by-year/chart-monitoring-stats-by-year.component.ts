...
@Component({
  selector: 'app-chart-monitoring-stats-by-year',
  templateUrl: './chart-monitoring-stats-by-year.component.html',
  styleUrls: ['./chart-monitoring-stats-by-year.component.css'],
})
export class ChartMonitoringStatsByYearComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('chart')
  chartRef: ElementRef;
