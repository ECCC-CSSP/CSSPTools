...
@Component({
  selector: 'app-chart-mwqm-run-data',
  templateUrl: './chart-mwqm-run-data.component.html',
  styleUrls: ['./chart-mwqm-run-data.component.css'],
})
export class ChartMWQMRunDataComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('chart')
  chartRef: ElementRef;
