...
@Component({
  selector: 'app-chart-mwqm-site-fc-stats',
  templateUrl: './chart-mwqm-site-fc-stats.component.html',
  styleUrls: ['./chart-mwqm-site-fc-stats.component.css'],
})
export class ChartMWQMSiteFCStatsComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('chart')
  chartRef: ElementRef;
