...
@Component({
  selector: 'app-mwqm-site-item-view-tables',
  templateUrl: './mwqm-site-item-view-tables.component.html',
  styleUrls: ['./mwqm-site-item-view-tables.component.css']
})
export class MWQMSiteItemViewTablesComponent implements OnInit, OnDestroy {
  ...
  webChartAndTableType = GetWebChartAndTableTypeEnum();
   ...
   TableFCStatsVisible: boolean = true;
