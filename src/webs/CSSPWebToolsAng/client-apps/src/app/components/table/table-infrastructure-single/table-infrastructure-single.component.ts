...
@Component({
  selector: 'app-table-infrastructure-single',
  templateUrl: './table-infrastructure-single.component.html',
  styleUrls: ['./table-infrastructure-single.component.css'],
})
export class TableInfrastructureSingleComponent implements OnInit, AfterViewInit, OnDestroy {
  @ViewChild('table')
  tableRef: ElementRef;
