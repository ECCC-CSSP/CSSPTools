...
export function FileTypeEnum_GetOrderedText(appService: AppService): EnumIDAndText[] {
...
export function FileTypeEnum_GetIDText(enumID: number, appService: AppService): string {
    let addressTypeEnunText: string;
    FileTypeEnum_GetOrderedText(appService).forEach(e => {
        if (e.EnumID == enumID) {
