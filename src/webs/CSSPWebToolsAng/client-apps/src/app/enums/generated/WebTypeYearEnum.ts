...
export function WebTypeYearEnum_GetOrderedText(): EnumIDAndText[] {
...
export function WebTypeYearEnum_GetIDText(enumID: number): string {
    let addressTypeEnunText: string;
    WebTypeYearEnum_GetOrderedText().forEach(e => {
        if (e.EnumID == enumID) {
