...
export class WebSector extends LastUpdate {
    MapInfoList: MapInfo[];
    MapInfoMikeScenarioList: MapInfo[];
    MapInfoPointList: MapInfoPoint[];
    MapInfoPointMikeScenarioList: MapInfoPoint[];
    MapInfoPointSubsectorList: MapInfoPoint[];
    MapInfoSubsectorList: MapInfo[];
    TVFileLanguageList: TVFileLanguage[];
    TVFileList: TVFile[];
    TVItem: TVItem;
    TVItemLanguageList: TVItemLanguage[];
    TVItemLanguageMikeScenarioList: TVItemLanguage[];
    TVItemLanguageSubsectorList: TVItemLanguage[];
    TVItemLinkList: TVItemLink[];
    TVItemMikeScenarioList: TVItem[];
    TVItemStatList: TVItemStat[];
    TVItemStatMikeScenarioList: TVItemStat[];
    TVItemStatSubsectorList: TVItemStat[];
    TVItemSubsectorList: TVItem[];
}
