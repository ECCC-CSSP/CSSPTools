            ...
            case TVTypeEnum.Infrastructure:
                {
                    for (let i = 0, countI = this.appLoadedService.WebMunicipality.InfrastructureModelList.length; i < countI; i++) {
                        for (let j = 0, countJ = this.appLoadedService.WebMunicipality.InfrastructureModelList[i].TVFileModelList.length; i < countJ; i++) {
            ...
            case TVTypeEnum.MWQMSite:
                {
                    for (let i = 0, countI = this.appLoadedService.WebMWQMSites.MWQMSiteModelList.length; i < countI; i++) {
                        for (let j = 0, countJ = this.appLoadedService.WebMWQMSites.MWQMSiteModelList[i].TVFileModelList.length; i < countJ; i++) {
            ...
            case TVTypeEnum.PolSourceSite:
                {
                    for (let i = 0, countI = this.appLoadedService.WebPolSourceSites.PolSourceSiteModelList.length; i < countI; i++) {
                        for (let j = 0, countJ = this.appLoadedService.WebPolSourceSites.PolSourceSiteModelList[i].TVFileModelList.length; i < countJ; i++) {
