...
export class WebMWQMSamples2021_2060Service {
    ...
    DoWebMWQMSamples2021_2060(TVItemID: number, DoNext: boolean = true, ForceReload: boolean = true) {
    ...
    private GetWebMWQMSamples2021_2060() {
        ...
        let url: string = `${this.appLoadedService.BaseApiUrl}${languageEnum[this.appLanguageService.Language]}-CA/Read/WebMWQMSamples2021_2060/${this.TVItemID}`;
    ...
    private KeepWebMWQMSamples2021_2060() {
        this.UpdateWebMWQMSamples2021_2060(this.appLoadedService.WebMWQMSamples2021_2060);
        console.debug(this.appLoadedService.WebMWQMSamples2021_2060);
        if (this.DoNext) {
        ...
        if (this.appStateService.GoogleJSLoaded) {
            if (this.appStateService.SubsectorSubComponent == SubsectorSubComponentEnum.MWQMSites) {
                ...
                this.mapService.DrawObjects([
                    ...this.appLoadedService.WebSubsector?.TVItemModelMWQMSiteList,
            ...
            if (this.appStateService.SubsectorSubComponent == SubsectorSubComponentEnum.MWQMRuns) {
                this.mapService.ClearMap();
                this.mapService.DrawObjects([
                    ...this.appLoadedService.WebSubsector?.TVItemModelMWQMRunList,
                    ...[this.appLoadedService.WebSubsector?.TVItemModel],
                ]);
            }
            ...
            if (this.appStateService.SubsectorSubComponent == SubsectorSubComponentEnum.PollutionSourceSites) {
                this.mapService.ClearMap();
                this.mapService.DrawObjects([
                    ...this.appLoadedService.WebSubsector?.TVItemModelPolSourceSiteList,
                    ...[this.appLoadedService.WebSubsector?.TVItemModel],
                ]);
            }
