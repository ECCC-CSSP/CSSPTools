...
import { AddressTextModel, WebRoot } from './address.models';
...
export class AddressService {
  ...
  webRootModel$: BehaviorSubject<WebRoot> = new BehaviorSubject<WebRoot>(<WebRoot>{});
  ...
  GetWebRoot() {
    ...
    return this.httpClient.get<WebRoot>('https://csspstorage.blob.core.windows.net/csspjson/WebRoot.json').pipe(
      map((x: any) => {
        this.httpClientService.DoSuccessSingle<WebRoot>(this.webRootModel$, this.webRootGetModel$, x, HttpClientCommand.Get, null);
      }),
      catchError(e => of(e).pipe(map(e => {
        this.httpClientService.DoCatchErrorSingle<WebRoot>(this.webRootModel$, this.webRootGetModel$, e);
      })))
    );
