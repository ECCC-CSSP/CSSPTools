...
namespace CSSPWebAPIs.CreateGzFileController.Tests
{
    public partial class CSSPWebAPIsCreateGzFileControllerTests
    {
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task CreateGzFileController_WebPolSourceSiteEffectTerm_Good_Test(string culture)
        {
            Assert.True(await Setup(culture));
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task CreateGzFileController_WebAllTVItem_Good_Test(string culture)
        {
            Assert.True(await Setup(culture));
        ...
        [InlineData("en-CA")]
        //[InlineData("fr-CA")]
        public async Task CreateGzFileController_WebAllTVItemLanguage_Good_Test(string culture)
        {
            Assert.True(await Setup(culture));
