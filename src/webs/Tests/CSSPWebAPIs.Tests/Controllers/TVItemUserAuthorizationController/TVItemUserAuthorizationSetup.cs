...
namespace CSSPWebAPIs.TVItemUserAuthorizationManualController.Tests
{
    public partial class CSSPWebAPIsTVItemUserAuthorizationManualControllerTests
    {
        ...
        private async Task<bool> TVItemUserAuthorizationSetup(string culture)
        {
            ...
            List<TVItemUserAuthorization> tvItemUserAuthorizationList = (from c in dbTempAzureTest.TVItemUserAuthorizations
                                                                         select c).ToList();

            try
            {
                dbTempAzureTest.TVItemUserAuthorizations.RemoveRange(tvItemUserAuthorizationList);
